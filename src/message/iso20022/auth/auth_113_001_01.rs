...
pub struct OrderEventType1Code {
	#[validate(enumerate = ["CAME", "CAMO", "CHME", "CHMO", "EXPI", "FILL", "NEWO", "PARF", "REMA", "REMO", "REMH", "REME", "TRIG", "RFQS", "RFQR"])]
...
pub struct OrderRestrictionType1Code {
	#[validate(enumerate = ["SESR", "VFAR", "VFCR"])]
...
pub struct OrderStatus10Code {
	#[validate(enumerate = ["ACTI", "INAC", "SUSP"])]
...
pub struct OrderStatus11Code {
	#[validate(enumerate = ["FIRM", "IMPL", "INDI", "ROUT"])]
...
pub struct ValidityPeriodType1Code {
	#[validate(enumerate = ["FOKV", "GADV", "GASV", "GATV", "DAVY", "GTCV", "GTDV", "GTSV", "GTTV", "IOCV"])]
