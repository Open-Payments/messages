...
pub struct FIToFIPaymentStatusReportV14 {
	...
	pub orgnl_grp_inf_and_sts: Option<Vec<OriginalGroupHeader22>>,
	#[serde(rename = "TxInfAndSts", skip_serializing_if = "Option::is_none")]
	pub tx_inf_and_sts: Option<Vec<PaymentTransaction161>>,
...
impl FIToFIPaymentStatusReportV14 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref orgnl_grp_inf_and_sts_vec) = self.orgnl_grp_inf_and_sts { for item in orgnl_grp_inf_and_sts_vec { if !item.validate() { return false; } } }
...
impl PaymentTransaction161 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref fctv_intr_bk_sttlm_dt_value) = self.fctv_intr_bk_sttlm_dt { if !fctv_intr_bk_sttlm_dt_value.validate() { return false; } }
