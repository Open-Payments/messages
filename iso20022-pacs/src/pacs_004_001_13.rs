...
impl CreditTransferTransaction63 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref prvs_instg_agt1_value) = self.prvs_instg_agt1 { if !prvs_instg_agt1_value.validate() { return false; } }
		if let Some(ref prvs_instg_agt1_acct_value) = self.prvs_instg_agt1_acct { if !prvs_instg_agt1_acct_value.validate() { return false; } }
		if let Some(ref prvs_instg_agt2_value) = self.prvs_instg_agt2 { if !prvs_instg_agt2_value.validate() { return false; } }
		if let Some(ref prvs_instg_agt2_acct_value) = self.prvs_instg_agt2_acct { if !prvs_instg_agt2_acct_value.validate() { return false; } }
		if let Some(ref prvs_instg_agt3_value) = self.prvs_instg_agt3 { if !prvs_instg_agt3_value.validate() { return false; } }
		if let Some(ref prvs_instg_agt3_acct_value) = self.prvs_instg_agt3_acct { if !prvs_instg_agt3_acct_value.validate() { return false; } }
		if let Some(ref intrmy_agt1_value) = self.intrmy_agt1 { if !intrmy_agt1_value.validate() { return false; } }
		if let Some(ref intrmy_agt1_acct_value) = self.intrmy_agt1_acct { if !intrmy_agt1_acct_value.validate() { return false; } }
		if let Some(ref intrmy_agt2_value) = self.intrmy_agt2 { if !intrmy_agt2_value.validate() { return false; } }
		if let Some(ref intrmy_agt2_acct_value) = self.intrmy_agt2_acct { if !intrmy_agt2_acct_value.validate() { return false; } }
		if let Some(ref intrmy_agt3_value) = self.intrmy_agt3 { if !intrmy_agt3_value.validate() { return false; } }
		if let Some(ref intrmy_agt3_acct_value) = self.intrmy_agt3_acct { if !intrmy_agt3_acct_value.validate() { return false; } }
		...
		if let Some(ref instr_for_nxt_agt_vec) = self.instr_for_nxt_agt { for item in instr_for_nxt_agt_vec { if !item.validate() { return false; } } }
...
impl GroupHeader123 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref authstn_vec) = self.authstn { for item in authstn_vec { if !item.validate() { return false; } } }
		if !self.nb_of_txs.validate() { return false }
		if let Some(ref ttl_rtrd_intr_bk_sttlm_amt_value) = self.ttl_rtrd_intr_bk_sttlm_amt { if !ttl_rtrd_intr_bk_sttlm_amt_value.validate() { return false; } }
		if !self.sttlm_inf.validate() { return false }
...
impl OriginalGroupHeader19 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref rtr_rsn_inf_vec) = self.rtr_rsn_inf { for item in rtr_rsn_inf_vec { if !item.validate() { return false; } } }
		return true
	}
}
...
impl OriginalTransactionReference41 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref undrlyg_cstmr_cdt_trf_value) = self.undrlyg_cstmr_cdt_trf { if !undrlyg_cstmr_cdt_trf_value.validate() { return false; } }
		return true
	}
}
...
impl PaymentTransaction159 {
	pub fn validate(&self) -> bool {
		if let Some(ref rtr_id_value) = self.rtr_id { if !rtr_id_value.validate() { return false; } }
		if let Some(ref orgnl_grp_inf_value) = self.orgnl_grp_inf { if !orgnl_grp_inf_value.validate() { return false; } }
		...
		if let Some(ref pmt_tp_inf_value) = self.pmt_tp_inf { if !pmt_tp_inf_value.validate() { return false; } }
		if !self.rtrd_intr_bk_sttlm_amt.validate() { return false }
		if let Some(ref sttlm_prty_value) = self.sttlm_prty { if !sttlm_prty_value.validate() { return false; } }
		if let Some(ref sttlm_tm_indctn_value) = self.sttlm_tm_indctn { if !sttlm_tm_indctn_value.validate() { return false; } }
		if let Some(ref sttlm_tm_req_value) = self.sttlm_tm_req { if !sttlm_tm_req_value.validate() { return false; } }
		if let Some(ref rtrd_instd_amt_value) = self.rtrd_instd_amt { if !rtrd_instd_amt_value.validate() { return false; } }
		if let Some(ref compstn_amt_value) = self.compstn_amt { if !compstn_amt_value.validate() { return false; } }
		...
		if let Some(ref instg_agt_value) = self.instg_agt { if !instg_agt_value.validate() { return false; } }
		if let Some(ref instd_agt_value) = self.instd_agt { if !instd_agt_value.validate() { return false; } }
		if let Some(ref rtr_chain_value) = self.rtr_chain { if !rtr_chain_value.validate() { return false; } }
		if let Some(ref rtr_rsn_inf_vec) = self.rtr_rsn_inf { for item in rtr_rsn_inf_vec { if !item.validate() { return false; } } }
