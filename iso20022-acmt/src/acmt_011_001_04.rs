...
pub struct AccountRequestRejectionV04 {
	...
	pub acct_id: Option<Vec<AccountForAction1>>,
	#[serde(rename = "OrgId")]
...
impl AccountRequestRejectionV04 {
	pub fn validate(&self) -> bool {
...
impl References6 {
	pub fn validate(&self) -> bool {
		if !self.rjctd_req_tp.validate() { return false }
		for item in &self.rjctn_rsn { if !item.validate() { return false; } }
		if !self.rjctd_req_id.validate() { return false }
