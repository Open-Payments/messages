...
impl AccountOpeningAdditionalInformationRequestV04 {
	pub fn validate(&self) -> bool {
...
impl References3 {
	pub fn validate(&self) -> bool {
		...
		if !self.req_to_be_cmpltd_id.validate() { return false }
		if !self.prc_id.validate() { return false }
		for item in &self.req_rsn { if !item.validate() { return false; } }
