...
pub struct AccountManagementStatus1Code {
	#[validate(enumerate = ["RECE", "ACCP", "EXEC", "STNP"])]
...
pub struct DisabledReason2Code {
	#[validate(enumerate = ["CLOS", "BKRP", "CMMT", "CNFS", "MORT", "PCOM", "PLDG", "TRPE", "SANC", "TRAN", "REJT"])]
...
pub struct PendingOpeningStatusReason1Code {
	#[validate(enumerate = ["ATHR", "ATHP", "FRDM", "KYCM", "NOTO", "REST", "RIGH"])]
...
pub struct PendingStatusReason1Code {
	#[validate(enumerate = ["KYCM", "FRDM", "RIGH", "ATHR", "ATHP", "MODI"])]
