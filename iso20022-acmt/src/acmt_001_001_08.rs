...
pub struct AccountOpeningInstructionV08 {
	...
	#[cfg_attr( feature = "derive_serde", serde(rename = "InstrDtls") )]
	pub instr_dtls: InvestmentAccountOpening4,
	#[cfg_attr( feature = "derive_serde", serde(rename = "InvstmtAcct") )]
	pub invstmt_acct: InvestmentAccount73,
	#[cfg_attr( feature = "derive_serde", serde(rename = "AcctPties") )]
