...
pub mod iso20022 {
	...
	pub struct AccountSwitchRequestBalanceTransferV05 {
		...
		#[cfg_attr( feature = "derive_serde", serde(rename = "NmntdAcct", skip_serializing_if = "Option::is_none") )]
	...
	impl AccountSwitchRequestBalanceTransferV05 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			...
			if let Some(ref val) = self.nmntd_acct { if let Err(e) = val.validate() { return Err(e); } }
