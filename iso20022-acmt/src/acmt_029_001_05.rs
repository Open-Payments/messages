...
// AccountSwitchCancelExistingPaymentV05 ...
#[derive(Debug, Default, PartialEq, Clone, Serialize, Deserialize)]
pub struct AccountSwitchCancelExistingPaymentV05 {
	#[serde(rename = "MsgId")]
	...
	#[serde(rename = "PmtInstr", skip_serializing_if = "Option::is_none")]
	pub pmt_instr: Option<Vec<PaymentInstruction43>>,
	#[serde(rename = "DrctDbtInstr", skip_serializing_if = "Option::is_none")]
	pub drct_dbt_instr: Option<Vec<DirectDebitInstructionDetails3>>,
	#[serde(rename = "SplmtryData", skip_serializing_if = "Option::is_none")]
	pub splmtry_data: Option<Vec<SupplementaryData1>>,
}

impl AccountSwitchCancelExistingPaymentV05 {
	pub fn validate(&self) -> bool {
		if !self.msg_id.validate() { return false }
		if !self.acct_swtch_dtls.validate() { return false }
		if !self.od_acct.validate() { return false }
		if let Some(ref pmt_instr_vec) = self.pmt_instr { for item in pmt_instr_vec { if !item.validate() { return false; } } }
		if let Some(ref drct_dbt_instr_vec) = self.drct_dbt_instr { for item in drct_dbt_instr_vec { if !item.validate() { return false; } } }
...
pub struct DirectDebitInstructionDetails3 {
	...
	#[serde(rename = "AutomtdDrctDbtInstrInd", skip_serializing_if = "Option::is_none")]
...
impl DirectDebitInstructionDetails3 {
	pub fn validate(&self) -> bool {
		if !self.mndt_id.validate() { return false }
		if !self.cdtr.validate() { return false }
		if let Some(ref last_colltn_ccy_amt_value) = self.last_colltn_ccy_amt { if !last_colltn_ccy_amt_value.validate() { return false; } }
...
impl PaymentInstruction43 {
	pub fn validate(&self) -> bool {
		if !self.pmt_inf_id.validate() { return false }
		...
		if let Some(ref instr_for_dbtr_agt_value) = self.instr_for_dbtr_agt { if !instr_for_dbtr_agt_value.validate() { return false; } }
		if let Some(ref ultmt_dbtr_value) = self.ultmt_dbtr { if !ultmt_dbtr_value.validate() { return false; } }
		if let Some(ref chrg_br_value) = self.chrg_br { if !chrg_br_value.validate() { return false; } }
		if let Some(ref chrgs_acct_value) = self.chrgs_acct { if !chrgs_acct_value.validate() { return false; } }
		if let Some(ref chrgs_acct_agt_value) = self.chrgs_acct_agt { if !chrgs_acct_agt_value.validate() { return false; } }
		for item in &self.cdt_trf_tx_inf { if !item.validate() { return false; } }
		return true
	}
}
