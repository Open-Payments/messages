...
pub struct AccountSwitchCancelExistingPaymentV05 {
	...
	#[validate]
	#[serde(rename = "PmtInstr")]
	pub pmt_instr: Option<Vec<PaymentInstruction43>>,
	#[validate]
	#[serde(rename = "DrctDbtInstr")]
...
pub struct PaymentMethod3Code {
	#[validate(enumerate = ["CHK", "TRF", "TRA"])]
