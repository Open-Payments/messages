...
impl IdentificationAssignment4 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref cretr_value) = self.cretr { if !cretr_value.validate() { return false; } }
		if let Some(ref frst_agt_value) = self.frst_agt { if !frst_agt_value.validate() { return false; } }
...
impl IdentificationVerificationReportV04 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref orgnl_assgnmt_value) = self.orgnl_assgnmt { if !orgnl_assgnmt_value.validate() { return false; } }
...
impl VerificationReport5 {
	pub fn validate(&self) -> bool {
		if !self.orgnl_id.validate() { return false }
		if let Some(ref rsn_value) = self.rsn { if !rsn_value.validate() { return false; } }
		if let Some(ref orgnl_pty_and_acct_id_value) = self.orgnl_pty_and_acct_id { if !orgnl_pty_and_acct_id_value.validate() { return false; } }
		if let Some(ref updtd_pty_and_acct_id_value) = self.updtd_pty_and_acct_id { if !updtd_pty_and_acct_id_value.validate() { return false; } }
		return true
	}
}
