...
pub struct CorrespondenceNotification1 {
	#[cfg_attr( feature = "derive_serde", serde(rename = "SndrNtfctnId") )]
	pub sndr_ntfctn_id: String,
	#[cfg_attr( feature = "derive_serde", serde(rename = "NtfctnTp") )]
	pub ntfctn_tp: NotificationType1Choice,
	#[cfg_attr( feature = "derive_serde", serde(rename = "NtfctnSubTp", skip_serializing_if = "Option::is_none") )]
	pub ntfctn_sub_tp: Option<NotificationSubType1Choice>,
	#[cfg_attr( feature = "derive_serde", serde(rename = "NtfctnNrrtv", skip_serializing_if = "Option::is_none") )]
	...
	#[cfg_attr( feature = "derive_serde", serde(rename = "RltdNtfctnData", skip_serializing_if = "Option::is_none") )]
...
impl CorrespondenceNotification1 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if self.sndr_ntfctn_id.chars().count() < 1 {
			return Err(ValidationError::new(1001, "sndr_ntfctn_id is shorter than the minimum length of 1".to_string()));
		}
		if self.sndr_ntfctn_id.chars().count() > 35 {
			return Err(ValidationError::new(1002, "sndr_ntfctn_id exceeds the maximum length of 35".to_string()));
		}
		self.ntfctn_tp.validate()?;
		if let Some(ref val) = self.ntfctn_sub_tp { val.validate()? }
		if let Some(ref vec) = self.ntfctn_nrrtv {
			for item in vec {
				if item.chars().count() < 1 {
					return Err(ValidationError::new(1001, "ntfctn_nrrtv is shorter than the minimum length of 1".to_string()));
				}
				if item.chars().count() > 2000 {
					return Err(ValidationError::new(1002, "ntfctn_nrrtv exceeds the maximum length of 2000".to_string()));
				}
			}
		}
		if let Some(ref vec) = self.nclsd_file { for item in vec { item.validate()? } }
		if let Some(ref vec) = self.rltd_ntfctn_data { for item in vec { item.validate()? } }
		Ok(())
	}
}
...
impl NotificationLocationData1 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		self.mtd.validate()?;
...
impl NotificationSubType1Choice {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref val) = self.prtry {
			if val.chars().count() < 1 {
				return Err(ValidationError::new(1001, "prtry is shorter than the minimum length of 1".to_string()));
...
pub struct RelatedNotificationData1 {
	#[cfg_attr( feature = "derive_serde", serde(rename = "NtfctnId", skip_serializing_if = "Option::is_none") )]
...
impl RelatedNotificationData1 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref val) = self.ntfctn_id {
			if val.chars().count() < 1 {
				return Err(ValidationError::new(1001, "ntfctn_id is shorter than the minimum length of 1".to_string()));
			}
			if val.chars().count() > 35 {
				return Err(ValidationError::new(1002, "ntfctn_id exceeds the maximum length of 35".to_string()));
			}
		}
...
pub struct ReportQuerySearchCriteria3 {
	...
	#[cfg_attr( feature = "derive_serde", serde(rename = "RptNm", skip_serializing_if = "Option::is_none") )]
	...
	#[cfg_attr( feature = "derive_serde", serde(rename = "SchdldTm", skip_serializing_if = "Option::is_none") )]
...
impl ReportQuerySearchCriteria3 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Some(ref val) = self.rpt_nm {
			if val.chars().count() < 1 {
				return Err(ValidationError::new(1001, "rpt_nm is shorter than the minimum length of 1".to_string()));
			}
			if val.chars().count() > 4 {
				return Err(ValidationError::new(1002, "rpt_nm exceeds the maximum length of 4".to_string()));
			}
			let pattern = Regex::new("[a-zA-Z0-9]{1,4}").unwrap();
			if !pattern.is_match(val) {
				return Err(ValidationError::new(1005, "rpt_nm does not match the required pattern".to_string()));
			}
		}
		if let Some(ref val) = self.msg_nm_id {
			if val.chars().count() < 1 {
		...
		if let Some(ref val) = self.schdld_tm { val.validate()? }
...
pub struct RequestDetails30 {
	#[cfg_attr( feature = "derive_serde", serde(rename = "Tp") )]
	pub tp: String,
	#[cfg_attr( feature = "derive_serde", serde(rename = "RqstrId", skip_serializing_if = "Option::is_none") )]
	pub rqstr_id: Option<PartyIdentification242Choice>,
	#[cfg_attr( feature = "derive_serde", serde(rename = "AddtlReqInf", skip_serializing_if = "Option::is_none") )]
	pub addtl_req_inf: Option<Vec<String>>,
}

impl RequestDetails30 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if self.tp.chars().count() < 1 {
			return Err(ValidationError::new(1001, "tp is shorter than the minimum length of 1".to_string()));
		}
		...
		if let Some(ref val) = self.rqstr_id { val.validate()? }
		if let Some(ref vec) = self.addtl_req_inf {
			for item in vec {
				if item.chars().count() < 1 {
					return Err(ValidationError::new(1001, "addtl_req_inf is shorter than the minimum length of 1".to_string()));
				}
				if item.chars().count() > 35 {
					return Err(ValidationError::new(1002, "addtl_req_inf exceeds the maximum length of 35".to_string()));
				}
			}
		}
		Ok(())
