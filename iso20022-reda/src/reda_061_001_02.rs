...
impl CutOff1 {
	pub fn validate(&self) -> bool {
		if !self.cut_off_upd_id.validate() { return false }
		if !self.ccy.validate() { return false }
		if !self.val_dt_offset.validate() { return false }
		return true
	}
}
...
impl CutOffData2 {
	pub fn validate(&self) -> bool {
		if !self.ptcpt_id.validate() { return false }
		for item in &self.netg_cut_off_dtls { if !item.validate() { return false; } }
		return true
	}
}
...
impl NettingCutOff2 {
	pub fn validate(&self) -> bool {
		if !self.netg_id.validate() { return false }
		for item in &self.new_cut_off { if !item.validate() { return false; } }
		return true
	}
}
...
impl NettingCutOffReferenceDataReportV02 {
	pub fn validate(&self) -> bool {
		...
		for item in &self.ptcpt_netg_cut_off_data { if !item.validate() { return false; } }
...
impl NettingCutOffReportData2 {
	pub fn validate(&self) -> bool {
		...
		if !self.rpt_tp.validate() { return false }
		if let Some(ref net_svc_ptcpt_id_value) = self.net_svc_ptcpt_id { if !net_svc_ptcpt_id_value.validate() { return false; } }
		if let Some(ref rpt_svcr_value) = self.rpt_svcr { if !rpt_svcr_value.validate() { return false; } }
