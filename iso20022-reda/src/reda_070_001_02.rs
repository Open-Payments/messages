...
pub mod iso20022 {
	...
	pub struct RequestToPayDebtorActivationRequestV02 {
		...
		#[cfg_attr( feature = "derive_serde", serde(rename = "DbtrActvtn") )]
		pub dbtr_actvtn: Vec<DebtorActivation5>,
		#[cfg_attr( feature = "derive_serde", serde(rename = "ElctrncInvcData") )]
	...
	impl RequestToPayDebtorActivationRequestV02 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			...
			for item in &self.dbtr_actvtn { if let Err(e) = item.validate() { return Err(e); } }
			if let Err(e) = self.elctrnc_invc_data.validate() { return Err(e); }
