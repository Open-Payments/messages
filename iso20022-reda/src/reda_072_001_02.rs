...
#[derive(Debug, Default, PartialEq, Clone, Serialize, Deserialize)]
#[serde(transparent)]
pub struct ExternalDebtorActivationCancellationReason1Code {
	#[serde(rename = "$value")]
	pub external_debtor_activation_cancellation_reason1_code: String,
}

impl ExternalDebtorActivationCancellationReason1Code {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if self.external_debtor_activation_cancellation_reason1_code.chars().count() < 1 {
			return Err(ValidationError::new(1001, "external_debtor_activation_cancellation_reason1_code is shorter than the minimum length of 1".to_string()));
		}
		if self.external_debtor_activation_cancellation_reason1_code.chars().count() > 4 {
			return Err(ValidationError::new(1002, "external_debtor_activation_cancellation_reason1_code exceeds the maximum length of 4".to_string()));
		}
		Ok(())
	}
}
...
// RequestToPayDebtorActivationCancellationRequestV02 ...
#[derive(Debug, Default, PartialEq, Clone, Serialize, Deserialize)]
...
impl RequestToPayDebtorActivationCancellationRequestV02 {
	pub fn validate(&self) -> Result<(), ValidationError> {
