...
pub struct CreditorEnrolment5 {
	...
	pub cdtr_tradg_nm: Option<Max140Text>,
	#[serde(rename = "Cdtr")]
	...
	pub cdtr_logo: Option<Max10KBinary>,
}

impl CreditorEnrolment5 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Err(e) = self.enrlmnt.validate() { return Err(e); }
		if let Some(ref cdtr_tradg_nm_value) = self.cdtr_tradg_nm { if let Err(e) = cdtr_tradg_nm_value.validate() { return Err(e); } }
		...
		if let Err(e) = self.mrchnt_ctgy_cd.validate() { return Err(e); }
		if let Some(ref cdtr_logo_value) = self.cdtr_logo { if let Err(e) = cdtr_logo_value.validate() { return Err(e); } }
		Ok(())
	}
}
...
pub struct CreditorEnrolment6 {
	#[serde(rename = "Enrlmnt", skip_serializing_if = "Option::is_none")]
	...
	pub mrchnt_ctgy_cd: Option<MerchantCategoryCodeIdentifier>,
	#[serde(rename = "CdtrLogo", skip_serializing_if = "Option::is_none")]
	pub cdtr_logo: Option<Max10KBinary>,
}
...
impl CreditorEnrolment6 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref enrlmnt_value) = self.enrlmnt { if let Err(e) = enrlmnt_value.validate() { return Err(e); } }
		if let Some(ref cdtr_tradg_nm_value) = self.cdtr_tradg_nm { if let Err(e) = cdtr_tradg_nm_value.validate() { return Err(e); } }
		if let Err(e) = self.cdtr.validate() { return Err(e); }
		if let Some(ref ultmt_cdtr_value) = self.ultmt_cdtr { if let Err(e) = ultmt_cdtr_value.validate() { return Err(e); } }
		if let Some(ref mrchnt_ctgy_cd_value) = self.mrchnt_ctgy_cd { if let Err(e) = mrchnt_ctgy_cd_value.validate() { return Err(e); } }
		if let Some(ref cdtr_logo_value) = self.cdtr_logo { if let Err(e) = cdtr_logo_value.validate() { return Err(e); } }
		Ok(())
	}
}
...
pub struct CreditorEnrolmentAmendment6 {
	#[serde(rename = "CdtrEnrlmnt", skip_serializing_if = "Option::is_none")]
	pub cdtr_enrlmnt: Option<CreditorEnrolment6>,
	#[serde(rename = "ActvtnData", skip_serializing_if = "Option::is_none")]
	pub actvtn_data: Option<CreditorInvoice5>,
}

impl CreditorEnrolmentAmendment6 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref cdtr_enrlmnt_value) = self.cdtr_enrlmnt { if let Err(e) = cdtr_enrlmnt_value.validate() { return Err(e); } }
		if let Some(ref actvtn_data_value) = self.actvtn_data { if let Err(e) = actvtn_data_value.validate() { return Err(e); } }
		Ok(())
	}
}
...
pub struct CreditorInvoice5 {
	#[serde(rename = "LtdPresntmntInd", skip_serializing_if = "Option::is_none")]
	...
	pub cdtr_instr: Option<Max500Text>,
...
impl CreditorInvoice5 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref cstmr_id_tp_value) = self.cstmr_id_tp { if let Err(e) = cstmr_id_tp_value.validate() { return Err(e); } }
		if let Some(ref ctrct_frmt_tp_vec) = self.ctrct_frmt_tp { for item in ctrct_frmt_tp_vec { if let Err(e) = item.validate() { return Err(e); } } }
		if let Some(ref ctrct_ref_tp_vec) = self.ctrct_ref_tp { for item in ctrct_ref_tp_vec { if let Err(e) = item.validate() { return Err(e); } } }
		if let Some(ref cdtr_instr_value) = self.cdtr_instr { if let Err(e) = cdtr_instr_value.validate() { return Err(e); } }
		if let Some(ref actvtn_req_dlvry_pty_value) = self.actvtn_req_dlvry_pty { if let Err(e) = actvtn_req_dlvry_pty_value.validate() { return Err(e); } }
		Ok(())
	}
}
...
pub struct CreditorServiceEnrolment1 {
	...
	pub svc_desc_lk: Option<Max2048Text>,
	#[serde(rename = "CdtrSvcActvtnLk", skip_serializing_if = "Option::is_none")]
	pub cdtr_svc_actvtn_lk: Option<Max2048Text>,
}

impl CreditorServiceEnrolment1 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref enrlmnt_start_dt_value) = self.enrlmnt_start_dt { if let Err(e) = enrlmnt_start_dt_value.validate() { return Err(e); } }
		if let Some(ref enrlmnt_end_dt_value) = self.enrlmnt_end_dt { if let Err(e) = enrlmnt_end_dt_value.validate() { return Err(e); } }
		if let Some(ref vsblty_value) = self.vsblty { if let Err(e) = vsblty_value.validate() { return Err(e); } }
		if let Some(ref svc_desc_lk_value) = self.svc_desc_lk { if let Err(e) = svc_desc_lk_value.validate() { return Err(e); } }
		if let Some(ref cdtr_svc_actvtn_lk_value) = self.cdtr_svc_actvtn_lk { if let Err(e) = cdtr_svc_actvtn_lk_value.validate() { return Err(e); } }
		Ok(())
	}
}
...
impl CustomerTypeRequest2 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref org_tp_value) = self.org_tp { if let Err(e) = org_tp_value.validate() { return Err(e); } }
		if let Some(ref prvt_tp_value) = self.prvt_tp { if let Err(e) = prvt_tp_value.validate() { return Err(e); } }
		Ok(())
	}
}
...
#[derive(Debug, Default, PartialEq, Clone, Serialize, Deserialize)]
#[serde(transparent)]
pub struct ExternalCreditorEnrolmentAmendmentReason1Code {
	#[serde(rename = "$value")]
	pub external_creditor_enrolment_amendment_reason1_code: String,
}

impl ExternalCreditorEnrolmentAmendmentReason1Code {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if self.external_creditor_enrolment_amendment_reason1_code.chars().count() < 1 {
			return Err(ValidationError::new(1001, "external_creditor_enrolment_amendment_reason1_code is shorter than the minimum length of 1".to_string()));
		}
		if self.external_creditor_enrolment_amendment_reason1_code.chars().count() > 4 {
			return Err(ValidationError::new(1002, "external_creditor_enrolment_amendment_reason1_code exceeds the maximum length of 4".to_string()));
		}
		Ok(())
	}
}
...
impl MerchantCategoryCodeIdentifier {
	pub fn validate(&self) -> Result<(), ValidationError> {
		let pattern = Regex::new("[0-9]{4,4}").unwrap();
		if !pattern.is_match(&self.merchant_category_code_identifier) {
			return Err(ValidationError::new(1005, "merchant_category_code_identifier does not match the required pattern".to_string()));
		}
		Ok(())
	}
}
...
pub struct OriginalEnrolment3Choice {
	#[serde(rename = "OrgnlCdtrId", skip_serializing_if = "Option::is_none")]
	pub orgnl_cdtr_id: Option<Party53Choice>,
	#[serde(rename = "OrgnlEnrlmntData", skip_serializing_if = "Option::is_none")]
	pub orgnl_enrlmnt_data: Option<CreditorEnrolment5>,
}

impl OriginalEnrolment3Choice {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref orgnl_cdtr_id_value) = self.orgnl_cdtr_id { if let Err(e) = orgnl_cdtr_id_value.validate() { return Err(e); } }
		if let Some(ref orgnl_enrlmnt_data_value) = self.orgnl_enrlmnt_data { if let Err(e) = orgnl_enrlmnt_data_value.validate() { return Err(e); } }
		Ok(())
	}
}
...
impl Visibilty1 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref start_dt_value) = self.start_dt { if let Err(e) = start_dt_value.validate() { return Err(e); } }
		if let Some(ref end_dt_value) = self.end_dt { if let Err(e) = end_dt_value.validate() { return Err(e); } }
		Ok(())
	}
}
