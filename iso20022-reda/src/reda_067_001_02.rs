...
impl CreditorEnrolment5 {
	pub fn validate(&self) -> bool {
		if !self.enrlmnt.validate() { return false }
		if let Some(ref cdtr_tradg_nm_value) = self.cdtr_tradg_nm { if !cdtr_tradg_nm_value.validate() { return false; } }
		...
		if !self.mrchnt_ctgy_cd.validate() { return false }
		if let Some(ref cdtr_logo_value) = self.cdtr_logo { if !cdtr_logo_value.validate() { return false; } }
		return true
	}
}
...
impl CreditorEnrolment6 {
	pub fn validate(&self) -> bool {
		if let Some(ref enrlmnt_value) = self.enrlmnt { if !enrlmnt_value.validate() { return false; } }
		if let Some(ref cdtr_tradg_nm_value) = self.cdtr_tradg_nm { if !cdtr_tradg_nm_value.validate() { return false; } }
		if !self.cdtr.validate() { return false }
		if let Some(ref ultmt_cdtr_value) = self.ultmt_cdtr { if !ultmt_cdtr_value.validate() { return false; } }
		if let Some(ref mrchnt_ctgy_cd_value) = self.mrchnt_ctgy_cd { if !mrchnt_ctgy_cd_value.validate() { return false; } }
		if let Some(ref cdtr_logo_value) = self.cdtr_logo { if !cdtr_logo_value.validate() { return false; } }
		return true
	}
}
...
impl CreditorEnrolmentAmendment5 {
	pub fn validate(&self) -> bool {
		...
		if !self.amdmnt.validate() { return false }
		if !self.orgnl_enrlmnt.validate() { return false }
...
impl CreditorEnrolmentAmendment6 {
	pub fn validate(&self) -> bool {
		if let Some(ref cdtr_enrlmnt_value) = self.cdtr_enrlmnt { if !cdtr_enrlmnt_value.validate() { return false; } }
		if let Some(ref actvtn_data_value) = self.actvtn_data { if !actvtn_data_value.validate() { return false; } }
		return true
	}
}
...
impl CreditorInvoice5 {
	pub fn validate(&self) -> bool {
		if let Some(ref cstmr_id_tp_value) = self.cstmr_id_tp { if !cstmr_id_tp_value.validate() { return false; } }
		if let Some(ref ctrct_frmt_tp_vec) = self.ctrct_frmt_tp { for item in ctrct_frmt_tp_vec { if !item.validate() { return false; } } }
		if let Some(ref ctrct_ref_tp_vec) = self.ctrct_ref_tp { for item in ctrct_ref_tp_vec { if !item.validate() { return false; } } }
		if let Some(ref cdtr_instr_value) = self.cdtr_instr { if !cdtr_instr_value.validate() { return false; } }
...
impl CreditorServiceEnrolment1 {
	pub fn validate(&self) -> bool {
		if let Some(ref enrlmnt_start_dt_value) = self.enrlmnt_start_dt { if !enrlmnt_start_dt_value.validate() { return false; } }
		if let Some(ref enrlmnt_end_dt_value) = self.enrlmnt_end_dt { if !enrlmnt_end_dt_value.validate() { return false; } }
		if let Some(ref vsblty_value) = self.vsblty { if !vsblty_value.validate() { return false; } }
		if let Some(ref svc_desc_lk_value) = self.svc_desc_lk { if !svc_desc_lk_value.validate() { return false; } }
		if let Some(ref cdtr_svc_actvtn_lk_value) = self.cdtr_svc_actvtn_lk { if !cdtr_svc_actvtn_lk_value.validate() { return false; } }
		return true
	}
}
...
impl CustomerTypeRequest2 {
	pub fn validate(&self) -> bool {
		if let Some(ref org_tp_value) = self.org_tp { if !org_tp_value.validate() { return false; } }
		if let Some(ref prvt_tp_value) = self.prvt_tp { if !prvt_tp_value.validate() { return false; } }
		return true
	}
}
...
impl GenericOrganisationType1 {
	pub fn validate(&self) -> bool {
		if !self.schme_nm.validate() { return false }
		return true
	}
}
...
impl OriginalEnrolment3Choice {
	pub fn validate(&self) -> bool {
		if let Some(ref orgnl_cdtr_id_value) = self.orgnl_cdtr_id { if !orgnl_cdtr_id_value.validate() { return false; } }
		if let Some(ref orgnl_enrlmnt_data_value) = self.orgnl_enrlmnt_data { if !orgnl_enrlmnt_data_value.validate() { return false; } }
		return true
	}
}
...
impl RequestToPayCreditorEnrolmentAmendmentRequestV02 {
	pub fn validate(&self) -> bool {
		...
		for item in &self.amdmnt_data { if !item.validate() { return false; } }
		if let Some(ref splmtry_data_vec) = self.splmtry_data { for item in splmtry_data_vec { if !item.validate() { return false; } } }
		return true
	}
}
