...
impl SecuritiesSearchCriteria4 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref isse_ccy_value) = self.isse_ccy { if !isse_ccy_value.validate() { return false; } }
		...
		if let Some(ref mntng_csd_value) = self.mntng_csd { if !mntng_csd_value.validate() { return false; } }
		...
		if let Some(ref csd_value) = self.csd { if !csd_value.validate() { return false; } }
		return true
	}
}
...
impl SecurityQueryV01 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref sml_set_rtr_crit_value) = self.sml_set_rtr_crit { if !sml_set_rtr_crit_value.validate() { return false; } }
