...
impl CommonFinancialInstrumentAttributes12 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Some(ref val) = self.nm_vld_fr { if let Err(e) = val.validate() { return Err(e); } }
...
impl SecurityAttributes12 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref vec) = self.fin_instrm_tp { for item in vec { if let Err(e) = item.validate() { return Err(e); } } }
...
impl SecurityMaintenanceRequestV01 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Some(ref val) = self.upd_rsn { if let Err(e) = val.validate() { return Err(e); } }
...
impl UpdateType35Choice {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref val) = self.add { if let Err(e) = val.validate() { return Err(e); } }
		if let Some(ref val) = self.del { if let Err(e) = val.validate() { return Err(e); } }
		if let Some(ref val) = self.modfy { if let Err(e) = val.validate() { return Err(e); } }
		Ok(())
	}
}
...
impl UpdateType36Choice {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref vec) = self.upd_tp { for item in vec { if let Err(e) = item.validate() { return Err(e); } } }
		if let Some(ref val) = self.rplc { if let Err(e) = val.validate() { return Err(e); } }
		Ok(())
	}
}
