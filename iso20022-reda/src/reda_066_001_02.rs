...
pub mod iso20022 {
	...
	impl CreditorInvoice6 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			...
			if let Err(e) = self.actvtn_req_dlvry_pty.validate() { return Err(e); }
			Ok(())
		}
	}
	...
	pub struct RequestToPayCreditorEnrolmentRequestV02 {
		...
		#[cfg_attr( feature = "derive_serde", serde(rename = "CdtrEnrlmnt") )]
		pub cdtr_enrlmnt: Vec<CreditorEnrolment5>,
		#[cfg_attr( feature = "derive_serde", serde(rename = "ActvtnData") )]
		pub actvtn_data: CreditorInvoice6,
		#[cfg_attr( feature = "derive_serde", serde(rename = "SplmtryData", skip_serializing_if = "Option::is_none") )]
		pub splmtry_data: Option<Vec<SupplementaryData1>>,
	}
	
	impl RequestToPayCreditorEnrolmentRequestV02 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			if let Err(e) = self.hdr.validate() { return Err(e); }
			for item in &self.cdtr_enrlmnt { if let Err(e) = item.validate() { return Err(e); } }
			if let Err(e) = self.actvtn_data.validate() { return Err(e); }
