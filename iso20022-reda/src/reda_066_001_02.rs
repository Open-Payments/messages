...
impl CreditorInvoice6 {
	pub fn validate(&self) -> bool {
		...
		if !self.actvtn_req_dlvry_pty.validate() { return false }
		return true
	}
}
...
impl RequestToPayCreditorEnrolmentRequestV02 {
	pub fn validate(&self) -> bool {
		...
		for item in &self.cdtr_enrlmnt { if !item.validate() { return false; } }
		if !self.actvtn_data.validate() { return false }
