...
impl DebtorActivation5 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref dbtr_actvtn_id_value) = self.dbtr_actvtn_id { if let Err(e) = dbtr_actvtn_id_value.validate() { return Err(e); } }
		if let Some(ref disp_nm_value) = self.disp_nm { if let Err(e) = disp_nm_value.validate() { return Err(e); } }
		...
		if let Err(e) = self.dbtr_sol_prvdr.validate() { return Err(e); }
		if let Some(ref cstmr_id_vec) = self.cstmr_id { for item in cstmr_id_vec { if let Err(e) = item.validate() { return Err(e); } } }
		...
		if let Some(ref ctrct_ref_vec) = self.ctrct_ref { for item in ctrct_ref_vec { if let Err(e) = item.validate() { return Err(e); } } }
		...
		if let Some(ref ddctd_actvtn_cd_value) = self.ddctd_actvtn_cd { if let Err(e) = ddctd_actvtn_cd_value.validate() { return Err(e); } }
		Ok(())
	}
}
...
impl DebtorActivation6 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Some(ref dbtr_sol_prvdr_value) = self.dbtr_sol_prvdr { if let Err(e) = dbtr_sol_prvdr_value.validate() { return Err(e); } }
		if let Some(ref cstmr_id_vec) = self.cstmr_id { for item in cstmr_id_vec { if let Err(e) = item.validate() { return Err(e); } } }
		if let Some(ref ctrct_frmt_tp_vec) = self.ctrct_frmt_tp { for item in ctrct_frmt_tp_vec { if let Err(e) = item.validate() { return Err(e); } } }
		if let Some(ref ctrct_ref_vec) = self.ctrct_ref { for item in ctrct_ref_vec { if let Err(e) = item.validate() { return Err(e); } } }
...
impl DebtorActivationAmendment5 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Err(e) = self.orgnl_actvtn.validate() { return Err(e); }
...
impl DebtorActivationAmendment6 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref dbtr_actvtn_value) = self.dbtr_actvtn { if let Err(e) = dbtr_actvtn_value.validate() { return Err(e); } }
		if let Some(ref elctrnc_invc_data_value) = self.elctrnc_invc_data { if let Err(e) = elctrnc_invc_data_value.validate() { return Err(e); } }
		Ok(())
	}
}
...
impl ElectronicInvoice1 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Err(e) = self.presntmnt_tp.validate() { return Err(e); }
		Ok(())
	}
}
...
impl ExternalDebtorActivationAmendmentReason1Code {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if self.external_debtor_activation_amendment_reason1_code.chars().count() < 1 {
			return Err(ValidationError::new(1001, "external_debtor_activation_amendment_reason1_code is shorter than the minimum length of 1".to_string()));
		}
		if self.external_debtor_activation_amendment_reason1_code.chars().count() > 4 {
			return Err(ValidationError::new(1002, "external_debtor_activation_amendment_reason1_code exceeds the maximum length of 4".to_string()));
		}
		Ok(())
	}
}
...
impl OriginalActivation3Choice {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref orgnl_dbtr_id_value) = self.orgnl_dbtr_id { if let Err(e) = orgnl_dbtr_id_value.validate() { return Err(e); } }
		if let Some(ref orgnl_actvtn_data_value) = self.orgnl_actvtn_data { if let Err(e) = orgnl_actvtn_data_value.validate() { return Err(e); } }
		Ok(())
	}
}
...
impl RequestToPayDebtorActivationAmendmentRequestV02 {
	pub fn validate(&self) -> Result<(), ValidationError> {
