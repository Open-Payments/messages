...
impl CustomerDirectDebitInitiationV11 {
	pub fn validate(&self) -> bool {
...
impl DirectDebitTransactionInformation32 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref instr_for_cdtr_agt_value) = self.instr_for_cdtr_agt { if !instr_for_cdtr_agt_value.validate() { return false; } }
...
impl PaymentInstruction45 {
	pub fn validate(&self) -> bool {
		...
		if !self.cdtr_acct.validate() { return false }
