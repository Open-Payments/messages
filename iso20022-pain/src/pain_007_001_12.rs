...
// CustomerPaymentReversalV12 ...
#[derive(Debug, Default, PartialEq, Clone, Serialize, Deserialize)]
pub struct CustomerPaymentReversalV12 {
	#[serde(rename = "GrpHdr")]
	...
	pub orgnl_pmt_inf_and_rvsl: Option<Vec<OriginalPaymentInstruction50>>,
	#[serde(rename = "SplmtryData", skip_serializing_if = "Option::is_none")]
	pub splmtry_data: Option<Vec<SupplementaryData1>>,
}

impl CustomerPaymentReversalV12 {
	pub fn validate(&self) -> bool {
		if !self.grp_hdr.validate() { return false }
		if !self.orgnl_grp_inf.validate() { return false }
		if let Some(ref orgnl_pmt_inf_and_rvsl_vec) = self.orgnl_pmt_inf_and_rvsl { for item in orgnl_pmt_inf_and_rvsl_vec { if !item.validate() { return false; } } }
...
impl OriginalPaymentInstruction50 {
	pub fn validate(&self) -> bool {
		if let Some(ref rvsl_pmt_inf_id_value) = self.rvsl_pmt_inf_id { if !rvsl_pmt_inf_id_value.validate() { return false; } }
