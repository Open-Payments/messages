...
impl AcceptanceResult6 {
	pub fn validate(&self) -> bool {
		if let Some(ref rjct_rsn_value) = self.rjct_rsn { if !rjct_rsn_value.validate() { return false; } }
		if let Some(ref addtl_rjct_rsn_inf_vec) = self.addtl_rjct_rsn_inf { for item in addtl_rjct_rsn_inf_vec { if !item.validate() { return false; } } }
		return true
	}
}
...
impl Mandate22 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref mndt_req_id_value) = self.mndt_req_id { if !mndt_req_id_value.validate() { return false; } }
		if let Some(ref authntcn_value) = self.authntcn { if !authntcn_value.validate() { return false; } }
		if let Some(ref tp_value) = self.tp { if !tp_value.validate() { return false; } }
		if let Some(ref ocrncs_value) = self.ocrncs { if !ocrncs_value.validate() { return false; } }
		if let Some(ref frst_colltn_amt_value) = self.frst_colltn_amt { if !frst_colltn_amt_value.validate() { return false; } }
		if let Some(ref colltn_amt_value) = self.colltn_amt { if !colltn_amt_value.validate() { return false; } }
		if let Some(ref max_amt_value) = self.max_amt { if !max_amt_value.validate() { return false; } }
		if let Some(ref adjstmnt_value) = self.adjstmnt { if !adjstmnt_value.validate() { return false; } }
		...
		if let Some(ref mndt_ref_value) = self.mndt_ref { if !mndt_ref_value.validate() { return false; } }
		if let Some(ref rfrd_doc_vec) = self.rfrd_doc { for item in rfrd_doc_vec { if !item.validate() { return false; } } }
		return true
	}
}
...
impl MandateAcceptance8 {
	pub fn validate(&self) -> bool {
		if let Some(ref orgnl_msg_inf_value) = self.orgnl_msg_inf { if !orgnl_msg_inf_value.validate() { return false; } }
		if !self.accptnc_rslt.validate() { return false }
		if let Some(ref orgnl_mndt_value) = self.orgnl_mndt { if !orgnl_mndt_value.validate() { return false; } }
...
impl MandateAcceptanceReportV08 {
	pub fn validate(&self) -> bool {
		...
		for item in &self.undrlyg_accptnc_dtls { if !item.validate() { return false; } }
		if let Some(ref splmtry_data_vec) = self.splmtry_data { for item in splmtry_data_vec { if !item.validate() { return false; } } }
		return true
	}
}
...
impl MandateAuthentication1 {
	pub fn validate(&self) -> bool {
		if let Some(ref msg_authntcn_cd_value) = self.msg_authntcn_cd { if !msg_authntcn_cd_value.validate() { return false; } }
		if let Some(ref chanl_value) = self.chanl { if !chanl_value.validate() { return false; } }
		return true
	}
}
...
impl MandateOccurrences5 {
	pub fn validate(&self) -> bool {
		if !self.seq_tp.validate() { return false }
...
impl ReferredMandateDocument2 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref cdtr_ref_value) = self.cdtr_ref { if !cdtr_ref_value.validate() { return false; } }
