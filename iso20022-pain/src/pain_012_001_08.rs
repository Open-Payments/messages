...
pub struct AcceptanceResult6 {
	...
	#[serde(rename = "AddtlRjctRsnInf", skip_serializing_if = "Option::is_none")]
	pub addtl_rjct_rsn_inf: Option<Vec<Max105Text>>,
}

impl AcceptanceResult6 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref rjct_rsn_value) = self.rjct_rsn { if let Err(e) = rjct_rsn_value.validate() { return Err(e); } }
		if let Some(ref addtl_rjct_rsn_inf_vec) = self.addtl_rjct_rsn_inf { for item in addtl_rjct_rsn_inf_vec { if let Err(e) = item.validate() { return Err(e); } } }
		Ok(())
	}
}
...
impl ExternalAuthenticationChannel1Code {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if self.external_authentication_channel1_code.chars().count() < 1 {
			return Err(ValidationError::new(1001, "external_authentication_channel1_code is shorter than the minimum length of 1".to_string()));
		}
		if self.external_authentication_channel1_code.chars().count() > 4 {
			return Err(ValidationError::new(1002, "external_authentication_channel1_code exceeds the maximum length of 4".to_string()));
		}
		Ok(())
	}
}
...
impl ExternalMandateReason1Code {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if self.external_mandate_reason1_code.chars().count() < 1 {
			return Err(ValidationError::new(1001, "external_mandate_reason1_code is shorter than the minimum length of 1".to_string()));
		}
		if self.external_mandate_reason1_code.chars().count() > 4 {
			return Err(ValidationError::new(1002, "external_mandate_reason1_code exceeds the maximum length of 4".to_string()));
		}
		Ok(())
	}
}
...
pub struct Mandate22 {
	...
	#[serde(rename = "RfrdDoc", skip_serializing_if = "Option::is_none")]
...
impl Mandate22 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Some(ref mndt_req_id_value) = self.mndt_req_id { if let Err(e) = mndt_req_id_value.validate() { return Err(e); } }
		if let Some(ref authntcn_value) = self.authntcn { if let Err(e) = authntcn_value.validate() { return Err(e); } }
		if let Some(ref tp_value) = self.tp { if let Err(e) = tp_value.validate() { return Err(e); } }
		if let Some(ref ocrncs_value) = self.ocrncs { if let Err(e) = ocrncs_value.validate() { return Err(e); } }
		if let Some(ref frst_colltn_amt_value) = self.frst_colltn_amt { if let Err(e) = frst_colltn_amt_value.validate() { return Err(e); } }
		if let Some(ref colltn_amt_value) = self.colltn_amt { if let Err(e) = colltn_amt_value.validate() { return Err(e); } }
		if let Some(ref max_amt_value) = self.max_amt { if let Err(e) = max_amt_value.validate() { return Err(e); } }
		if let Some(ref adjstmnt_value) = self.adjstmnt { if let Err(e) = adjstmnt_value.validate() { return Err(e); } }
		...
		if let Some(ref mndt_ref_value) = self.mndt_ref { if let Err(e) = mndt_ref_value.validate() { return Err(e); } }
		if let Some(ref rfrd_doc_vec) = self.rfrd_doc { for item in rfrd_doc_vec { if let Err(e) = item.validate() { return Err(e); } } }
		Ok(())
	}
}
...
impl MandateAcceptance8 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref orgnl_msg_inf_value) = self.orgnl_msg_inf { if let Err(e) = orgnl_msg_inf_value.validate() { return Err(e); } }
		if let Err(e) = self.accptnc_rslt.validate() { return Err(e); }
		if let Some(ref orgnl_mndt_value) = self.orgnl_mndt { if let Err(e) = orgnl_mndt_value.validate() { return Err(e); } }
...
impl MandateAcceptanceReportV08 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Err(e) = self.grp_hdr.validate() { return Err(e); }
		for item in &self.undrlyg_accptnc_dtls { if let Err(e) = item.validate() { return Err(e); } }
		if let Some(ref splmtry_data_vec) = self.splmtry_data { for item in splmtry_data_vec { if let Err(e) = item.validate() { return Err(e); } } }
		Ok(())
	}
}
...
impl MandateAuthentication1 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref msg_authntcn_cd_value) = self.msg_authntcn_cd { if let Err(e) = msg_authntcn_cd_value.validate() { return Err(e); } }
		if let Some(ref chanl_value) = self.chanl { if let Err(e) = chanl_value.validate() { return Err(e); } }
		Ok(())
	}
}
...
impl ReferredMandateDocument2 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Some(ref cdtr_ref_value) = self.cdtr_ref { if let Err(e) = cdtr_ref_value.validate() { return Err(e); } }
