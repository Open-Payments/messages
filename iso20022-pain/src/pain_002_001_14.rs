...
impl CustomerPaymentStatusReportV14 {
	pub fn validate(&self) -> bool {
...
impl PaymentTransaction160 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref trckr_data_value) = self.trckr_data { if !trckr_data_value.validate() { return false; } }
...
impl TrackerData7 {
	pub fn validate(&self) -> bool {
		if !self.confd_dt.validate() { return false }
		if !self.confd_amt.validate() { return false }
		for item in &self.trckr_rcrd { if !item.validate() { return false; } }
		return true
	}
}
...
impl TrackerRecord5 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref chrgs_amt_value) = self.chrgs_amt { if !chrgs_amt_value.validate() { return false; } }
		if let Some(ref xchg_rate_data_value) = self.xchg_rate_data { if !xchg_rate_data_value.validate() { return false; } }
		return true
	}
}
