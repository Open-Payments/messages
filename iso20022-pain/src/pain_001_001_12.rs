...
impl AdviceType1 {
	pub fn validate(&self) -> bool {
		if let Some(ref cdt_advc_value) = self.cdt_advc { if !cdt_advc_value.validate() { return false; } }
		if let Some(ref dbt_advc_value) = self.dbt_advc { if !dbt_advc_value.validate() { return false; } }
		return true
	}
}
...
impl CustomerCreditTransferInitiationV12 {
	pub fn validate(&self) -> bool {
		...
		for item in &self.pmt_inf { if !item.validate() { return false; } }
		if let Some(ref splmtry_data_vec) = self.splmtry_data { for item in splmtry_data_vec { if !item.validate() { return false; } } }
		return true
	}
}
...
impl GroupHeader114 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref initn_src_value) = self.initn_src { if !initn_src_value.validate() { return false; } }
		return true
	}
}
...
impl PaymentInitiationSource1 {
	pub fn validate(&self) -> bool {
		if !self.nm.validate() { return false }
		if let Some(ref prvdr_value) = self.prvdr { if !prvdr_value.validate() { return false; } }
...
impl PaymentInstruction44 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref reqd_advc_tp_value) = self.reqd_advc_tp { if !reqd_advc_tp_value.validate() { return false; } }
		if let Some(ref nb_of_txs_value) = self.nb_of_txs { if !nb_of_txs_value.validate() { return false; } }
		if let Some(ref pmt_tp_inf_value) = self.pmt_tp_inf { if !pmt_tp_inf_value.validate() { return false; } }
		if !self.reqd_exctn_dt.validate() { return false }
