...
impl AdviceType1 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref val) = self.cdt_advc { if let Err(e) = val.validate() { return Err(e); } }
		if let Some(ref val) = self.dbt_advc { if let Err(e) = val.validate() { return Err(e); } }
		Ok(())
	}
}
...
impl CreditTransferTransaction65 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Some(ref val) = self.pmt_cond { if let Err(e) = val.validate() { return Err(e); } }
...
impl PaymentCondition2 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Some(ref val) = self.imdt_pmt_rbt { if let Err(e) = val.validate() { return Err(e); } }
		Ok(())
	}
}
...
impl PaymentInstruction46 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Some(ref val) = self.reqd_advc_tp { if let Err(e) = val.validate() { return Err(e); } }
		if let Some(ref val) = self.pmt_tp_inf { if let Err(e) = val.validate() { return Err(e); } }
		if let Some(ref val) = self.reqd_exctn_dt { if let Err(e) = val.validate() { return Err(e); } }
		if let Some(ref val) = self.xpry_dt { if let Err(e) = val.validate() { return Err(e); } }
		if let Some(ref val) = self.pmt_cond { if let Err(e) = val.validate() { return Err(e); } }
		...
		if let Some(ref val) = self.ultmt_dbtr { if let Err(e) = val.validate() { return Err(e); } }
		if let Some(ref val) = self.chrg_br { if let Err(e) = val.validate() { return Err(e); } }
		for item in &self.cdt_trf_tx { if let Err(e) = item.validate() { return Err(e); } }
		Ok(())
	}
}
