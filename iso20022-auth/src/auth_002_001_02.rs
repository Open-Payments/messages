...
pub struct AuthorityInvestigation2 {
	...
	#[validate]
	#[serde(rename = "AddtlInvstgtdPties")]
...
#[derive(Debug, PartialEq, Clone, Validate, Serialize, Deserialize)]
pub struct InvestigatedParties1Code {
	#[validate(enumerate = ["ALLP", "OWNE"])]
	#[serde(rename = "InvestigatedParties1Code")]
	pub investigated_parties1_code: String,
}
...
pub struct InvestigationResult1Choice {
	...
	pub invstgtn_sts: Option<String>,
}


// InvestigationStatus1Code ...
#[derive(Debug, PartialEq, Clone, Validate, Serialize, Deserialize)]
pub struct InvestigationStatus1Code {
	#[validate(enumerate = ["FOUN", "NFOU", "NOAP"])]
	#[serde(rename = "InvestigationStatus1Code")]
	pub investigation_status1_code: String,
}
...
// StatusResponse1Code ...
#[derive(Debug, PartialEq, Clone, Validate, Serialize, Deserialize)]
pub struct StatusResponse1Code {
	#[validate(enumerate = ["NRES", "PART", "COMP"])]
	#[serde(rename = "StatusResponse1Code")]
	pub status_response1_code: String,
}
...
#[derive(Debug, PartialEq, Clone, Validate, Serialize, Deserialize)]
pub struct TransactionRequestType1Code {
	#[validate(enumerate = ["DTTX", "OREC"])]
	#[serde(rename = "TransactionRequestType1Code")]
	pub transaction_request_type1_code: String,
}
