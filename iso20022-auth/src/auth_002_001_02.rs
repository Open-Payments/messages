...
impl AccountAndParties3 {
	pub fn validate(&self) -> bool {
		...
		if !self.invstgtd_pties.validate() { return false }
		for item in &self.authrty_req_tp { if !item.validate() { return false; } }
		return true
	}
}
...
impl AuthorityInvestigation2 {
	pub fn validate(&self) -> bool {
		...
		if !self.invstgtd_roles.validate() { return false }
		if let Some(ref addtl_invstgtd_pties_value) = self.addtl_invstgtd_pties { if !addtl_invstgtd_pties_value.validate() { return false; } }
...
impl CustomerIdentification2 {
	pub fn validate(&self) -> bool {
		...
		for item in &self.authrty_req { if !item.validate() { return false; } }
		return true
	}
}
...
impl InformationRequestResponseV02 {
	pub fn validate(&self) -> bool {
		if !self.rspn_id.validate() { return false }
		if !self.invstgtn_id.validate() { return false }
		if !self.rspn_sts.validate() { return false }
		if !self.sch_crit.validate() { return false }
		for item in &self.rtr_ind { if !item.validate() { return false; } }
...
impl InvestigationResult1Choice {
	pub fn validate(&self) -> bool {
		if let Some(ref rslt_value) = self.rslt { if !rslt_value.validate() { return false; } }
		if let Some(ref invstgtn_sts_value) = self.invstgtn_sts { if !invstgtn_sts_value.validate() { return false; } }
		return true
	}
}
...
impl PaymentInstrumentType1 {
	pub fn validate(&self) -> bool {
		if !self.card_nb.validate() { return false }
		for item in &self.authrty_req_tp { if !item.validate() { return false; } }
		if let Some(ref addtl_inf_value) = self.addtl_inf { if !addtl_inf_value.validate() { return false; } }
		return true
	}
...
impl RequestType1 {
	pub fn validate(&self) -> bool {
		...
		for item in &self.tp { if !item.validate() { return false; } }
		if let Some(ref addtl_inf_value) = self.addtl_inf { if !addtl_inf_value.validate() { return false; } }
		return true
	}
}
...
impl ReturnIndicator2 {
	pub fn validate(&self) -> bool {
		if let Some(ref rspn_prd_value) = self.rspn_prd { if !rspn_prd_value.validate() { return false; } }
		if !self.authrty_req_tp.validate() { return false }
		if !self.invstgtn_rslt.validate() { return false }
		if let Some(ref addtl_inf_value) = self.addtl_inf { if !addtl_inf_value.validate() { return false; } }
		return true
	}
}
...
impl SearchCriteria2Choice {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref cstmr_id_value) = self.cstmr_id { if !cstmr_id_value.validate() { return false; } }
		if let Some(ref pmt_instrm_value) = self.pmt_instrm { if !pmt_instrm_value.validate() { return false; } }
		if let Some(ref orgnl_tx_nb_vec) = self.orgnl_tx_nb { for item in orgnl_tx_nb_vec { if !item.validate() { return false; } } }
		return true
	}
}
