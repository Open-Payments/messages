...
impl PaymentRegulatoryInformationNotificationV04 {
	pub fn validate(&self) -> bool {
		...
		for item in &self.tx_ntfctn { if !item.validate() { return false; } }
...
impl RegulatoryReportingNotification4 {
	pub fn validate(&self) -> bool {
		if !self.tx_ntfctn_id.validate() { return false }
		if !self.acct_ownr.validate() { return false }
		if !self.acct_svcr.validate() { return false }
		for item in &self.tx_cert { if !item.validate() { return false; } }
		return true
	}
}
