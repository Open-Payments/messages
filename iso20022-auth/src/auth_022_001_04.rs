...
impl ContractRegistrationReference2Choice {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref regd_ctrct_id_value) = self.regd_ctrct_id { if let Err(e) = regd_ctrct_id_value.validate() { return Err(e); } }
		if let Some(ref ctrct_value) = self.ctrct { if let Err(e) = ctrct_value.validate() { return Err(e); } }
		Ok(())
	}
}
...
impl ContractRegistrationStatement4 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Err(e) = self.regd_ctrct.validate() { return Err(e); }
		if let Some(ref tx_jrnl_vec) = self.tx_jrnl { for item in tx_jrnl_vec { if let Err(e) = item.validate() { return Err(e); } } }
		if let Some(ref spprtg_doc_jrnl_vec) = self.spprtg_doc_jrnl { for item in spprtg_doc_jrnl_vec { if let Err(e) = item.validate() { return Err(e); } } }
		if let Some(ref addtl_spprtg_doc_jrnl_vec) = self.addtl_spprtg_doc_jrnl { for item in addtl_spprtg_doc_jrnl_vec { if let Err(e) = item.validate() { return Err(e); } } }
		if let Some(ref rgltry_rule_vldtn_vec) = self.rgltry_rule_vldtn { for item in rgltry_rule_vldtn_vec { if let Err(e) = item.validate() { return Err(e); } } }
		if let Err(e) = self.ttl_ctrct_trnvr_sum.validate() { return Err(e); }
...
impl DocumentAmendment1 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref orgnl_doc_id_value) = self.orgnl_doc_id { if let Err(e) = orgnl_doc_id_value.validate() { return Err(e); } }
		Ok(())
	}
}
...
impl DocumentEntryAmendment1 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Err(e) = self.orgnl_doc.validate() { return Err(e); }
		Ok(())
	}
}
...
impl Exact4AlphaNumericUnderscoreText {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if !pattern.is_match(&self.exact4_alpha_numeric_underscore_text) {
			return Err(ValidationError::new(1005, "exact4_alpha_numeric_underscore_text does not match the required pattern".to_string()));
		}
		Ok(())
	}
}
...
impl ExternalShipmentCondition1Code {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if self.external_shipment_condition1_code.chars().count() < 1 {
			return Err(ValidationError::new(1001, "external_shipment_condition1_code is shorter than the minimum length of 1".to_string()));
		}
		if self.external_shipment_condition1_code.chars().count() > 4 {
			return Err(ValidationError::new(1002, "external_shipment_condition1_code exceeds the maximum length of 4".to_string()));
		}
		Ok(())
	}
}
...
impl ShipmentAttribute2 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref conds_value) = self.conds { if let Err(e) = conds_value.validate() { return Err(e); } }
		if let Some(ref ctry_of_cntr_pty_value) = self.ctry_of_cntr_pty { if let Err(e) = ctry_of_cntr_pty_value.validate() { return Err(e); } }
		Ok(())
	}
}
...
impl SupportingDocument4 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Err(e) = self.spprtg_doc_id.validate() { return Err(e); }
		if let Some(ref orgnl_req_id_value) = self.orgnl_req_id { if let Err(e) = orgnl_req_id_value.validate() { return Err(e); } }
		if let Err(e) = self.cert.validate() { return Err(e); }
		if let Err(e) = self.acct_ownr.validate() { return Err(e); }
		if let Err(e) = self.acct_svcr.validate() { return Err(e); }
		if let Some(ref amdmnt_value) = self.amdmnt { if let Err(e) = amdmnt_value.validate() { return Err(e); } }
		if let Err(e) = self.ctrct_ref.validate() { return Err(e); }
		for item in &self.ntry { if let Err(e) = item.validate() { return Err(e); } }
		if let Some(ref splmtry_data_vec) = self.splmtry_data { for item in splmtry_data_vec { if let Err(e) = item.validate() { return Err(e); } } }
		Ok(())
	}
}
...
impl SupportingDocumentEntry2 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Err(e) = self.ntry_id.validate() { return Err(e); }
		if let Err(e) = self.orgnl_doc.validate() { return Err(e); }
		if let Err(e) = self.doc_tp.validate() { return Err(e); }
		if let Some(ref ttl_amt_value) = self.ttl_amt { if let Err(e) = ttl_amt_value.validate() { return Err(e); } }
		if let Some(ref ttl_amt_aftr_shipmnt_value) = self.ttl_amt_aftr_shipmnt { if let Err(e) = ttl_amt_aftr_shipmnt_value.validate() { return Err(e); } }
		if let Some(ref ttl_amt_in_ctrct_ccy_value) = self.ttl_amt_in_ctrct_ccy { if let Err(e) = ttl_amt_in_ctrct_ccy_value.validate() { return Err(e); } }
		if let Some(ref ttl_amt_aftr_shipmnt_in_ctrct_ccy_value) = self.ttl_amt_aftr_shipmnt_in_ctrct_ccy { if let Err(e) = ttl_amt_aftr_shipmnt_in_ctrct_ccy_value.validate() { return Err(e); } }
		if let Err(e) = self.shipmnt_attrbts.validate() { return Err(e); }
		if let Some(ref ntry_amdmnt_id_value) = self.ntry_amdmnt_id { if let Err(e) = ntry_amdmnt_id_value.validate() { return Err(e); } }
		if let Some(ref mtrty_data_value) = self.mtrty_data { if let Err(e) = mtrty_data_value.validate() { return Err(e); } }
		if let Some(ref addtl_inf_value) = self.addtl_inf { if let Err(e) = addtl_inf_value.validate() { return Err(e); } }
		if let Some(ref attchmnt_vec) = self.attchmnt { for item in attchmnt_vec { if let Err(e) = item.validate() { return Err(e); } } }
		Ok(())
	}
...
impl TransactionCertificate4 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Some(ref bk_acct_dmcltn_ctry_value) = self.bk_acct_dmcltn_ctry { if let Err(e) = bk_acct_dmcltn_ctry_value.validate() { return Err(e); } }
		if let Some(ref amdmnt_value) = self.amdmnt { if let Err(e) = amdmnt_value.validate() { return Err(e); } }
		for item in &self.cert_rcrd { if let Err(e) = item.validate() { return Err(e); } }
		if let Some(ref splmtry_data_vec) = self.splmtry_data { for item in splmtry_data_vec { if let Err(e) = item.validate() { return Err(e); } } }
		Ok(())
	}
}
...
impl TransactionCertificate5 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Err(e) = self.rfrd_doc.validate() { return Err(e); }
		if let Some(ref tx_tp_value) = self.tx_tp { if let Err(e) = tx_tp_value.validate() { return Err(e); } }
		if let Err(e) = self.lcl_instrm.validate() { return Err(e); }
		if let Err(e) = self.amt.validate() { return Err(e); }
		Ok(())
	}
}
...
impl TransactionCertificateContract2 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Some(ref tx_amt_in_ctrct_ccy_value) = self.tx_amt_in_ctrct_ccy { if let Err(e) = tx_amt_in_ctrct_ccy_value.validate() { return Err(e); } }
		if let Some(ref addtl_inf_value) = self.addtl_inf { if let Err(e) = addtl_inf_value.validate() { return Err(e); } }
		Ok(())
	}
}
...
impl TransactionCertificateRecord2 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Err(e) = self.cert_rcrd_id.validate() { return Err(e); }
		if let Some(ref doc_submitg_prcdr_value) = self.doc_submitg_prcdr { if let Err(e) = doc_submitg_prcdr_value.validate() { return Err(e); } }
