...
pub struct TransparencyDataReport11 {
	...
	#[serde(rename = "HldgsExcdgTtlVtngRghtThrshld", skip_serializing_if = "Option::is_none")]
...
impl TransparencyDataReport11 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref issnc_sz_value) = self.issnc_sz { if !issnc_sz_value.validate() { return false; } }
		if let Some(ref instrm_pric_value) = self.instrm_pric { if !instrm_pric_value.validate() { return false; } }
		return true
	}
}
