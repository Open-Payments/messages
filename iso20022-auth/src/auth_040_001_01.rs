...
impl FinancialInstrumentReportingEquityTradingActivityReportV01 {
	pub fn validate(&self) -> bool {
...
impl NumberAndVolume2 {
	pub fn validate(&self) -> bool {
		if !self.vol.validate() { return false }
		return true
	}
}
...
impl TransparencyDataReport13 {
	pub fn validate(&self) -> bool {
		...
		if !self.txs_exctd.validate() { return false }
		if !self.txs_exctd_exclg_pre_trad_wvr.validate() { return false }
		if !self.txs_exctd_exclg_pst_trad_lrg_in_scale_wvr.validate() { return false }
		return true
	}
}
