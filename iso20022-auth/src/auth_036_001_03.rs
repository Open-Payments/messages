...
pub struct FinancialInstrumentReportingReferenceDataDeltaReportV03 {
	...
	#[serde(rename = "FinInstrm", skip_serializing_if = "Option::is_none")]
	pub fin_instrm: Option<Vec<SecuritiesReferenceDeltaStatusReport5Choice>>,
	#[serde(rename = "SplmtryData", skip_serializing_if = "Option::is_none")]
	pub splmtry_data: Option<Vec<SupplementaryData1>>,
}

impl FinancialInstrumentReportingReferenceDataDeltaReportV03 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Err(e) = self.rpt_hdr.validate() { return Err(e); }
		if let Some(ref fin_instrm_vec) = self.fin_instrm { for item in fin_instrm_vec { if let Err(e) = item.validate() { return Err(e); } } }
...
pub struct SecuritiesReferenceDeltaStatusReport5Choice {
	...
	#[serde(rename = "CancRcrd", skip_serializing_if = "Option::is_none")]
	pub canc_rcrd: Option<SecuritiesReferenceDataReport7>,
}

impl SecuritiesReferenceDeltaStatusReport5Choice {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref modfd_rcrd_value) = self.modfd_rcrd { if let Err(e) = modfd_rcrd_value.validate() { return Err(e); } }
		if let Some(ref new_rcrd_value) = self.new_rcrd { if let Err(e) = new_rcrd_value.validate() { return Err(e); } }
		if let Some(ref termntd_rcrd_value) = self.termntd_rcrd { if let Err(e) = termntd_rcrd_value.validate() { return Err(e); } }
		if let Some(ref canc_rcrd_value) = self.canc_rcrd { if let Err(e) = canc_rcrd_value.validate() { return Err(e); } }
		Ok(())
	}
}
