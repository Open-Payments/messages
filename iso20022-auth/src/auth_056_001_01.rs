...
impl CCPMemberObligationsReportV01 {
	pub fn validate(&self) -> bool {
		for item in &self.sttlm_acct { if !item.validate() { return false; } }
...
impl SettlementAccount1 {
	pub fn validate(&self) -> bool {
		if !self.id.validate() { return false }
		if !self.end_of_day_initl_mrgn_clld.validate() { return false }
		if !self.end_of_day_vartn_mrgn_clld.validate() { return false }
		if !self.end_of_day_dflt_fnd_clld.validate() { return false }
		if !self.end_of_day_sttlm_clld.validate() { return false }
		if !self.end_of_day_othr_clld.validate() { return false }
		if !self.end_of_day_lqdty_clld.validate() { return false }
		return true
	}
}
