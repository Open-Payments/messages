...
impl ExternalUnableToApplyIncorrectData1Code {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if self.external_unable_to_apply_incorrect_data1_code.chars().count() < 1 {
			return Err(ValidationError::new(1001, "external_unable_to_apply_incorrect_data1_code is shorter than the minimum length of 1".to_string()));
		}
		if self.external_unable_to_apply_incorrect_data1_code.chars().count() > 4 {
			return Err(ValidationError::new(1002, "external_unable_to_apply_incorrect_data1_code exceeds the maximum length of 4".to_string()));
		}
		Ok(())
	}
}
...
impl ExternalUnableToApplyMissingData1Code {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if self.external_unable_to_apply_missing_data1_code.chars().count() < 1 {
			return Err(ValidationError::new(1001, "external_unable_to_apply_missing_data1_code is shorter than the minimum length of 1".to_string()));
		}
		if self.external_unable_to_apply_missing_data1_code.chars().count() > 4 {
			return Err(ValidationError::new(1002, "external_unable_to_apply_missing_data1_code exceeds the maximum length of 4".to_string()));
		}
		Ok(())
	}
}
...
impl MissingOrIncorrectData1 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref mssng_inf_vec) = self.mssng_inf { for item in mssng_inf_vec { if let Err(e) = item.validate() { return Err(e); } } }
		if let Some(ref incrrct_inf_vec) = self.incrrct_inf { for item in incrrct_inf_vec { if let Err(e) = item.validate() { return Err(e); } } }
		Ok(())
	}
}
...
impl UnableToApplyIncorrect2 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Err(e) = self.tp.validate() { return Err(e); }
		if let Some(ref addtl_incrrct_inf_value) = self.addtl_incrrct_inf { if let Err(e) = addtl_incrrct_inf_value.validate() { return Err(e); } }
		Ok(())
	}
}
...
impl UnableToApplyJustification4Choice {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref mssng_or_incrrct_inf_value) = self.mssng_or_incrrct_inf { if let Err(e) = mssng_or_incrrct_inf_value.validate() { return Err(e); } }
		Ok(())
	}
}
...
impl UnableToApplyMissing2 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Err(e) = self.tp.validate() { return Err(e); }
		if let Some(ref addtl_mssng_inf_value) = self.addtl_mssng_inf { if let Err(e) = addtl_mssng_inf_value.validate() { return Err(e); } }
		Ok(())
	}
}
...
impl UnableToApplyV10 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Err(e) = self.justfn.validate() { return Err(e); }
...
impl UnderlyingStatementEntry3 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Some(ref orgnl_ntry_id_value) = self.orgnl_ntry_id { if let Err(e) = orgnl_ntry_id_value.validate() { return Err(e); } }
		if let Some(ref orgnl_uetr_value) = self.orgnl_uetr { if let Err(e) = orgnl_uetr_value.validate() { return Err(e); } }
		Ok(())
	}
}
