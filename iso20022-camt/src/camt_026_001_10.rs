...
impl ExternalUnableToApplyIncorrectData1Code {
	pub fn validate(&self) -> bool {
		if self.external_unable_to_apply_incorrect_data1_code.chars().count() < 1 {
			return false
		}
		if self.external_unable_to_apply_incorrect_data1_code.chars().count() > 4 {
			return false
		}
		return true
	}
...
impl ExternalUnableToApplyMissingData1Code {
	pub fn validate(&self) -> bool {
		if self.external_unable_to_apply_missing_data1_code.chars().count() < 1 {
			return false
		}
		if self.external_unable_to_apply_missing_data1_code.chars().count() > 4 {
			return false
		}
		return true
	}
...
pub struct MissingOrIncorrectData1 {
	...
	#[serde(rename = "MssngInf", skip_serializing_if = "Option::is_none")]
	pub mssng_inf: Option<Vec<UnableToApplyMissing2>>,
	#[serde(rename = "IncrrctInf", skip_serializing_if = "Option::is_none")]
	pub incrrct_inf: Option<Vec<UnableToApplyIncorrect2>>,
}

impl MissingOrIncorrectData1 {
	pub fn validate(&self) -> bool {
		if let Some(ref mssng_inf_vec) = self.mssng_inf { for item in mssng_inf_vec { if !item.validate() { return false; } } }
		if let Some(ref incrrct_inf_vec) = self.incrrct_inf { for item in incrrct_inf_vec { if !item.validate() { return false; } } }
		return true
	}
}
...
impl UnableToApplyIncorrect2 {
	pub fn validate(&self) -> bool {
		if !self.tp.validate() { return false }
		if let Some(ref addtl_incrrct_inf_value) = self.addtl_incrrct_inf { if !addtl_incrrct_inf_value.validate() { return false; } }
		return true
	}
}
...
impl UnableToApplyJustification4Choice {
	pub fn validate(&self) -> bool {
		if let Some(ref mssng_or_incrrct_inf_value) = self.mssng_or_incrrct_inf { if !mssng_or_incrrct_inf_value.validate() { return false; } }
		return true
	}
}
...
impl UnableToApplyMissing2 {
	pub fn validate(&self) -> bool {
		if !self.tp.validate() { return false }
		if let Some(ref addtl_mssng_inf_value) = self.addtl_mssng_inf { if !addtl_mssng_inf_value.validate() { return false; } }
		return true
	}
}
