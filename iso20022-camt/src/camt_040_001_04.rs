...
impl EstimatedFundCashForecast6 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref estmtd_ttl_nav_vec) = self.estmtd_ttl_nav { for item in estmtd_ttl_nav_vec { if !item.validate() { return false; } } }
		if let Some(ref prvs_ttl_nav_vec) = self.prvs_ttl_nav { for item in prvs_ttl_nav_vec { if !item.validate() { return false; } } }
		if let Some(ref estmtd_ttl_units_nb_value) = self.estmtd_ttl_units_nb { if !estmtd_ttl_units_nb_value.validate() { return false; } }
		...
		if let Some(ref estmtd_csh_in_fcst_dtls_vec) = self.estmtd_csh_in_fcst_dtls { for item in estmtd_csh_in_fcst_dtls_vec { if !item.validate() { return false; } } }
		if let Some(ref estmtd_csh_out_fcst_dtls_vec) = self.estmtd_csh_out_fcst_dtls { for item in estmtd_csh_out_fcst_dtls_vec { if !item.validate() { return false; } } }
		if let Some(ref estmtd_net_csh_fcst_dtls_vec) = self.estmtd_net_csh_fcst_dtls { for item in estmtd_net_csh_fcst_dtls_vec { if !item.validate() { return false; } } }
		return true
	}
}
...
impl Fund1 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref prvs_trad_dt_tm_value) = self.prvs_trad_dt_tm { if !prvs_trad_dt_tm_value.validate() { return false; } }
		if let Some(ref estmtd_ttl_nav_value) = self.estmtd_ttl_nav { if !estmtd_ttl_nav_value.validate() { return false; } }
...
impl FundEstimatedCashForecastReportV04 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref estmtd_fnd_csh_fcst_dtls_vec) = self.estmtd_fnd_csh_fcst_dtls { for item in estmtd_fnd_csh_fcst_dtls_vec { if !item.validate() { return false; } } }
