...
pub struct EstimatedFundCashForecast6 {
	...
	#[serde(rename = "EstmtdTtlNAVChngRate")]
...
pub struct Fund1 {
	...
	#[serde(rename = "PrvsTtlUnitsNb")]
	pub prvs_ttl_units_nb: Option<FinancialInstrumentQuantity1>,
	#[serde(rename = "EstmtdPctgOfFndTtlNAV")]
