...
impl AccountStatement13 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref stmt_pgntn_value) = self.stmt_pgntn { if !stmt_pgntn_value.validate() { return false; } }
		...
		for item in &self.bal { if !item.validate() { return false; } }
		...
		if let Some(ref addtl_stmt_inf_value) = self.addtl_stmt_inf { if !addtl_stmt_inf_value.validate() { return false; } }
		return true
	}
}
...
impl CashBalance8 {
	pub fn validate(&self) -> bool {
		if !self.tp.validate() { return false }
		if let Some(ref cdt_line_vec) = self.cdt_line { for item in cdt_line_vec { if !item.validate() { return false; } } }
		if !self.amt.validate() { return false }
		if !self.cdt_dbt_ind.validate() { return false }
		if !self.dt.validate() { return false }
