...
#[derive(Debug, PartialEq, Clone, Validate, Serialize, Deserialize)]
pub struct ChequePartyRole1Code {
	#[validate(enumerate = ["DWEA", "DWRA", "PAYE", "PAYR"])]
	#[serde(rename = "ChequePartyRole1Code")]
	pub cheque_party_role1_code: String,
}
...
pub struct ExternalChequeCancellationReason1Code {
	#[validate(min_length = 1)]
	#[validate(max_length = 4)]
	#[serde(rename = "ExternalChequeCancellationReason1Code")]
