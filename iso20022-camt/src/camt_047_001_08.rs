...
pub struct CurrentAndDefaultReservation6 {
	...
	#[serde(rename = "DfltRsvatn", skip_serializing_if = "Option::is_none")]
	pub dflt_rsvatn: Option<Vec<ReservationReport8>>,
}

impl CurrentAndDefaultReservation6 {
	pub fn validate(&self) -> bool {
		if let Some(ref cur_rsvatn_vec) = self.cur_rsvatn { for item in cur_rsvatn_vec { if !item.validate() { return false; } } }
		if let Some(ref dflt_rsvatn_vec) = self.dflt_rsvatn { for item in dflt_rsvatn_vec { if !item.validate() { return false; } } }
		return true
	}
}
...
impl ReservationIdentification4 {
	pub fn validate(&self) -> bool {
		if let Some(ref rsvatn_id_value) = self.rsvatn_id { if !rsvatn_id_value.validate() { return false; } }
...
impl ReservationOrError9Choice {
	pub fn validate(&self) -> bool {
		if let Some(ref rsvatn_value) = self.rsvatn { if !rsvatn_value.validate() { return false; } }
...
impl ReservationReport8 {
	pub fn validate(&self) -> bool {
		if !self.rsvatn_id.validate() { return false }
		if !self.rsvatn_or_err.validate() { return false }
		return true
	}
}
