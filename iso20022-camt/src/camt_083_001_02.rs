...
impl IntraBalanceCancellation7 {
	pub fn validate(&self) -> bool {
		...
		for item in &self.cxl { if !item.validate() { return false; } }
		return true
	}
}
...
impl IntraBalanceMovementCancellationReportV02 {
	pub fn validate(&self) -> bool {
		if let Some(ref id_value) = self.id { if !id_value.validate() { return false; } }
...
impl IntraBalanceOrOperationalError10Choice {
	pub fn validate(&self) -> bool {
		if let Some(ref cxls_vec) = self.cxls { for item in cxls_vec { if !item.validate() { return false; } } }
...
impl ProcessingStatus69Choice {
	pub fn validate(&self) -> bool {
		if let Some(ref pdg_cxl_value) = self.pdg_cxl { if !pdg_cxl_value.validate() { return false; } }
