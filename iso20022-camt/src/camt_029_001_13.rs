...
impl Charges14 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref agt_acct_value) = self.agt_acct { if !agt_acct_value.validate() { return false; } }
		if let Some(ref tp_value) = self.tp { if !tp_value.validate() { return false; } }
		return true
	}
}
...
impl ClaimNonReceipt3 {
	pub fn validate(&self) -> bool {
		if let Some(ref orgnl_nxt_agt_value) = self.orgnl_nxt_agt { if !orgnl_nxt_agt_value.validate() { return false; } }
		return true
	}
}
...
impl ClaimNonReceipt3Choice {
	pub fn validate(&self) -> bool {
		if let Some(ref accptd_value) = self.accptd { if !accptd_value.validate() { return false; } }
...
impl CorrectiveGroupInformation1 {
	pub fn validate(&self) -> bool {
		...
		if !self.msg_nm_id.validate() { return false }
		return true
	}
}
...
impl CorrectiveInterbankTransaction3 {
	pub fn validate(&self) -> bool {
		if let Some(ref grp_hdr_value) = self.grp_hdr { if !grp_hdr_value.validate() { return false; } }
		...
		if !self.intr_bk_sttlm_amt.validate() { return false }
		return true
	}
}
...
impl CorrectivePaymentInitiation5 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref end_to_end_id_value) = self.end_to_end_id { if !end_to_end_id_value.validate() { return false; } }
		if let Some(ref uetr_value) = self.uetr { if !uetr_value.validate() { return false; } }
		if !self.instd_amt.validate() { return false }
...
impl InvestigationStatus6Choice {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref rjctd_mod_vec) = self.rjctd_mod { for item in rjctd_mod_vec { if !item.validate() { return false; } } }
		if let Some(ref dplct_of_value) = self.dplct_of { if !dplct_of_value.validate() { return false; } }
		return true
	}
}
...
impl NumberOfCancellationsPerStatus1 {
	pub fn validate(&self) -> bool {
		if !self.dtld_nb_of_txs.validate() { return false }
...
impl OriginalGroupHeader23 {
	pub fn validate(&self) -> bool {
		if let Some(ref orgnl_grp_cxl_id_value) = self.orgnl_grp_cxl_id { if !orgnl_grp_cxl_id_value.validate() { return false; } }
		if let Some(ref rslvd_case_value) = self.rslvd_case { if !rslvd_case_value.validate() { return false; } }
		...
		if let Some(ref grp_cxl_sts_value) = self.grp_cxl_sts { if !grp_cxl_sts_value.validate() { return false; } }
		if let Some(ref cxl_sts_rsn_inf_vec) = self.cxl_sts_rsn_inf { for item in cxl_sts_rsn_inf_vec { if !item.validate() { return false; } } }
		if let Some(ref nb_of_txs_per_cxl_sts_vec) = self.nb_of_txs_per_cxl_sts { for item in nb_of_txs_per_cxl_sts_vec { if !item.validate() { return false; } } }
		return true
	}
}
...
impl OriginalPaymentInstruction48 {
	pub fn validate(&self) -> bool {
		if let Some(ref orgnl_pmt_inf_cxl_id_value) = self.orgnl_pmt_inf_cxl_id { if !orgnl_pmt_inf_cxl_id_value.validate() { return false; } }
		if let Some(ref rslvd_case_value) = self.rslvd_case { if !rslvd_case_value.validate() { return false; } }
		if !self.orgnl_pmt_inf_id.validate() { return false }
		if let Some(ref orgnl_grp_inf_value) = self.orgnl_grp_inf { if !orgnl_grp_inf_value.validate() { return false; } }
		if let Some(ref orgnl_nb_of_txs_value) = self.orgnl_nb_of_txs { if !orgnl_nb_of_txs_value.validate() { return false; } }
		if let Some(ref pmt_inf_cxl_sts_value) = self.pmt_inf_cxl_sts { if !pmt_inf_cxl_sts_value.validate() { return false; } }
		if let Some(ref cxl_sts_rsn_inf_vec) = self.cxl_sts_rsn_inf { for item in cxl_sts_rsn_inf_vec { if !item.validate() { return false; } } }
		if let Some(ref nb_of_txs_per_cxl_sts_vec) = self.nb_of_txs_per_cxl_sts { for item in nb_of_txs_per_cxl_sts_vec { if !item.validate() { return false; } } }
		if let Some(ref tx_inf_and_sts_vec) = self.tx_inf_and_sts { for item in tx_inf_and_sts_vec { if !item.validate() { return false; } } }
		return true
	}
}
...
impl PaymentTransaction152 {
	pub fn validate(&self) -> bool {
		if let Some(ref cxl_sts_id_value) = self.cxl_sts_id { if !cxl_sts_id_value.validate() { return false; } }
		if let Some(ref rslvd_case_value) = self.rslvd_case { if !rslvd_case_value.validate() { return false; } }
		if let Some(ref orgnl_grp_inf_value) = self.orgnl_grp_inf { if !orgnl_grp_inf_value.validate() { return false; } }
		...
		if let Some(ref orgnl_clr_sys_ref_value) = self.orgnl_clr_sys_ref { if !orgnl_clr_sys_ref_value.validate() { return false; } }
		if let Some(ref orgnl_uetr_value) = self.orgnl_uetr { if !orgnl_uetr_value.validate() { return false; } }
		if let Some(ref tx_cxl_sts_value) = self.tx_cxl_sts { if !tx_cxl_sts_value.validate() { return false; } }
		if let Some(ref cxl_sts_rsn_inf_vec) = self.cxl_sts_rsn_inf { for item in cxl_sts_rsn_inf_vec { if !item.validate() { return false; } } }
		if let Some(ref rsltn_rltd_inf_value) = self.rsltn_rltd_inf { if !rsltn_rltd_inf_value.validate() { return false; } }
		...
		if let Some(ref assgnr_value) = self.assgnr { if !assgnr_value.validate() { return false; } }
		if let Some(ref assgne_value) = self.assgne { if !assgne_value.validate() { return false; } }
...
impl PaymentTransaction153 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref orgnl_reqd_exctn_dt_value) = self.orgnl_reqd_exctn_dt { if !orgnl_reqd_exctn_dt_value.validate() { return false; } }
		if let Some(ref orgnl_tx_ref_value) = self.orgnl_tx_ref { if !orgnl_tx_ref_value.validate() { return false; } }
		return true
	}
}
...
impl PaymentTransaction157 {
	pub fn validate(&self) -> bool {
		if let Some(ref mod_sts_id_value) = self.mod_sts_id { if !mod_sts_id_value.validate() { return false; } }
		if let Some(ref rslvd_case_value) = self.rslvd_case { if !rslvd_case_value.validate() { return false; } }
		if !self.orgnl_grp_inf.validate() { return false }
		...
		if let Some(ref orgnl_clr_sys_ref_value) = self.orgnl_clr_sys_ref { if !orgnl_clr_sys_ref_value.validate() { return false; } }
		if let Some(ref orgnl_uetr_value) = self.orgnl_uetr { if !orgnl_uetr_value.validate() { return false; } }
		if let Some(ref mod_sts_rsn_inf_vec) = self.mod_sts_rsn_inf { for item in mod_sts_rsn_inf_vec { if !item.validate() { return false; } } }
		if let Some(ref rsltn_rltd_inf_value) = self.rsltn_rltd_inf { if !rsltn_rltd_inf_value.validate() { return false; } }
		if let Some(ref orgnl_intr_bk_sttlm_amt_value) = self.orgnl_intr_bk_sttlm_amt { if !orgnl_intr_bk_sttlm_amt_value.validate() { return false; } }
		if let Some(ref assgnr_value) = self.assgnr { if !assgnr_value.validate() { return false; } }
		if let Some(ref assgne_value) = self.assgne { if !assgne_value.validate() { return false; } }
...
impl ResolutionData5 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref chrgs_inf_vec) = self.chrgs_inf { for item in chrgs_inf_vec { if !item.validate() { return false; } } }
		return true
	}
}
...
impl ResolutionOfInvestigationV13 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref cxl_dtls_vec) = self.cxl_dtls { for item in cxl_dtls_vec { if !item.validate() { return false; } } }
		if let Some(ref mod_dtls_value) = self.mod_dtls { if !mod_dtls_value.validate() { return false; } }
		if let Some(ref clm_non_rct_dtls_value) = self.clm_non_rct_dtls { if !clm_non_rct_dtls_value.validate() { return false; } }
		if let Some(ref stmt_dtls_value) = self.stmt_dtls { if !stmt_dtls_value.validate() { return false; } }
		if let Some(ref crrctn_tx_value) = self.crrctn_tx { if !crrctn_tx_value.validate() { return false; } }
		if let Some(ref rsltn_rltd_inf_value) = self.rsltn_rltd_inf { if !rsltn_rltd_inf_value.validate() { return false; } }
...
impl StatementResolutionEntry5 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref crrctd_amt_value) = self.crrctd_amt { if !crrctd_amt_value.validate() { return false; } }
		if let Some(ref chrgs_vec) = self.chrgs { for item in chrgs_vec { if !item.validate() { return false; } } }
		if let Some(ref purp_value) = self.purp { if !purp_value.validate() { return false; } }
		return true
	}
}
...
impl UnderlyingTransaction32 {
	pub fn validate(&self) -> bool {
		if let Some(ref orgnl_grp_inf_and_sts_value) = self.orgnl_grp_inf_and_sts { if !orgnl_grp_inf_and_sts_value.validate() { return false; } }
		if let Some(ref orgnl_pmt_inf_and_sts_vec) = self.orgnl_pmt_inf_and_sts { for item in orgnl_pmt_inf_and_sts_vec { if !item.validate() { return false; } } }
		if let Some(ref tx_inf_and_sts_vec) = self.tx_inf_and_sts { for item in tx_inf_and_sts_vec { if !item.validate() { return false; } } }
		return true
	}
}
