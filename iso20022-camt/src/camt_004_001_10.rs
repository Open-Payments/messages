...
impl AccountOrOperationalError6Choice {
	pub fn validate(&self) -> bool {
		if let Some(ref acct_rpt_vec) = self.acct_rpt { for item in acct_rpt_vec { if !item.validate() { return false; } } }
...
impl AccountReport35 {
	pub fn validate(&self) -> bool {
		...
		if !self.acct_or_err.validate() { return false }
		return true
	}
}
...
impl BalanceRestrictionType1 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref prcg_tp_value) = self.prcg_tp { if !prcg_tp_value.validate() { return false; } }
		return true
	}
}
...
impl BilateralLimit4 {
	pub fn validate(&self) -> bool {
		...
		if !self.lmt_amt.validate() { return false }
		if !self.cdt_dbt_ind.validate() { return false }
		if let Some(ref bil_bal_vec) = self.bil_bal { for item in bil_bal_vec { if !item.validate() { return false; } } }
		return true
	}
}
...
impl CashAccountData1 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref ccy_value) = self.ccy { if !ccy_value.validate() { return false; } }
		if let Some(ref prxy_value) = self.prxy { if !prxy_value.validate() { return false; } }
		if let Some(ref cur_mul_lmt_value) = self.cur_mul_lmt { if !cur_mul_lmt_value.validate() { return false; } }
		...
		if let Some(ref mul_bal_vec) = self.mul_bal { for item in mul_bal_vec { if !item.validate() { return false; } } }
		if let Some(ref cur_bil_lmt_vec) = self.cur_bil_lmt { for item in cur_bil_lmt_vec { if !item.validate() { return false; } } }
		if let Some(ref stg_ordr_vec) = self.stg_ordr { for item in stg_ordr_vec { if !item.validate() { return false; } } }
		return true
	}
}
...
impl CashBalance13 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref sts_value) = self.sts { if !sts_value.validate() { return false; } }
		if let Some(ref val_dt_value) = self.val_dt { if !val_dt_value.validate() { return false; } }
		if let Some(ref prcg_dt_value) = self.prcg_dt { if !prcg_dt_value.validate() { return false; } }
...
impl ExecutionType1Choice {
	pub fn validate(&self) -> bool {
		if let Some(ref evt_value) = self.evt { if !evt_value.validate() { return false; } }
		return true
	}
}
...
impl StandingOrder11 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref ccy_value) = self.ccy { if !ccy_value.validate() { return false; } }
		if let Some(ref tp_value) = self.tp { if !tp_value.validate() { return false; } }
		if let Some(ref assoctd_pool_acct_value) = self.assoctd_pool_acct { if !assoctd_pool_acct_value.validate() { return false; } }
		...
		if let Some(ref sys_mmb_value) = self.sys_mmb { if !sys_mmb_value.validate() { return false; } }
		if let Some(ref rspnsbl_pty_value) = self.rspnsbl_pty { if !rspnsbl_pty_value.validate() { return false; } }
		if let Some(ref lk_set_id_value) = self.lk_set_id { if !lk_set_id_value.validate() { return false; } }
		if let Some(ref lk_set_ordr_id_value) = self.lk_set_ordr_id { if !lk_set_ordr_id_value.validate() { return false; } }
		if let Some(ref exctn_tp_value) = self.exctn_tp { if !exctn_tp_value.validate() { return false; } }
		...
		if let Some(ref ttls_per_stg_ordr_value) = self.ttls_per_stg_ordr { if !ttls_per_stg_ordr_value.validate() { return false; } }
		return true
	}
}
...
impl StandingOrderTotalAmount1 {
	pub fn validate(&self) -> bool {
		if !self.set_prdfnd_ordr.validate() { return false }
		if !self.pdg_prdfnd_ordr.validate() { return false }
		if !self.set_stg_ordr.validate() { return false }
		if !self.pdg_stg_ordr.validate() { return false }
		return true
	}
}
