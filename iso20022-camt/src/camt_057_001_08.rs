...
impl AccountNotification23 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref intrmy_agt_value) = self.intrmy_agt { if !intrmy_agt_value.validate() { return false; } }
		for item in &self.itm { if !item.validate() { return false; } }
		return true
	}
}
...
impl NotificationItem9 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref rltd_rmt_inf_value) = self.rltd_rmt_inf { if !rltd_rmt_inf_value.validate() { return false; } }
...
// NotificationToReceiveV08 ...
#[derive(Debug, Default, PartialEq, Clone, Serialize, Deserialize)]
pub struct NotificationToReceiveV08 {
	#[serde(rename = "GrpHdr")]
	pub grp_hdr: GroupHeader117,
	#[serde(rename = "Ntfctn")]
	pub ntfctn: AccountNotification23,
	#[serde(rename = "SplmtryData", skip_serializing_if = "Option::is_none")]
	pub splmtry_data: Option<Vec<SupplementaryData1>>,
}

impl NotificationToReceiveV08 {
	pub fn validate(&self) -> bool {
		if !self.grp_hdr.validate() { return false }
		if !self.ntfctn.validate() { return false }
