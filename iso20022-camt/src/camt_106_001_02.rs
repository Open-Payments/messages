...
impl Charges3Choice {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref per_tx_value) = self.per_tx { if !per_tx_value.validate() { return false; } }
		if let Some(ref per_tp_vec) = self.per_tp { for item in per_tp_vec { if !item.validate() { return false; } } }
		return true
	}
}
...
impl ChargesPaymentRequestV02 {
	pub fn validate(&self) -> bool {
		...
		if !self.chrgs.validate() { return false }
...
impl ChargesPerTransaction3 {
	pub fn validate(&self) -> bool {
		if let Some(ref chrgs_id_value) = self.chrgs_id { if !chrgs_id_value.validate() { return false; } }
		if let Some(ref ttl_chrgs_per_tx_value) = self.ttl_chrgs_per_tx { if !ttl_chrgs_per_tx_value.validate() { return false; } }
		if let Some(ref chrgs_acct_agt_value) = self.chrgs_acct_agt { if !chrgs_acct_agt_value.validate() { return false; } }
		if let Some(ref chrgs_acct_agt_acct_value) = self.chrgs_acct_agt_acct { if !chrgs_acct_agt_acct_value.validate() { return false; } }
		for item in &self.rcrd { if !item.validate() { return false; } }
...
impl ChargesPerTransactionRecord3 {
	pub fn validate(&self) -> bool {
		if let Some(ref rcrd_id_value) = self.rcrd_id { if !rcrd_id_value.validate() { return false; } }
		if let Some(ref chrgs_rqstr_value) = self.chrgs_rqstr { if !chrgs_rqstr_value.validate() { return false; } }
		if !self.undrlyg_tx.validate() { return false }
		if let Some(ref ttl_chrgs_per_rcrd_value) = self.ttl_chrgs_per_rcrd { if !ttl_chrgs_per_rcrd_value.validate() { return false; } }
		for item in &self.chrgs_brkdwn { if !item.validate() { return false; } }
		...
		if let Some(ref chrgs_acct_agt_value) = self.chrgs_acct_agt { if !chrgs_acct_agt_value.validate() { return false; } }
		if let Some(ref chrgs_acct_agt_acct_value) = self.chrgs_acct_agt_acct { if !chrgs_acct_agt_acct_value.validate() { return false; } }
		if let Some(ref instr_for_instd_agt_value) = self.instr_for_instd_agt { if !instr_for_instd_agt_value.validate() { return false; } }
		if let Some(ref addtl_inf_value) = self.addtl_inf { if !addtl_inf_value.validate() { return false; } }
		return true
	}
}
...
impl ChargesPerType3 {
	pub fn validate(&self) -> bool {
		if let Some(ref chrgs_id_value) = self.chrgs_id { if !chrgs_id_value.validate() { return false; } }
		if let Some(ref ttl_chrgs_per_chrg_tp_value) = self.ttl_chrgs_per_chrg_tp { if !ttl_chrgs_per_chrg_tp_value.validate() { return false; } }
		if let Some(ref chrgs_acct_agt_value) = self.chrgs_acct_agt { if !chrgs_acct_agt_value.validate() { return false; } }
		if let Some(ref chrgs_acct_agt_acct_value) = self.chrgs_acct_agt_acct { if !chrgs_acct_agt_acct_value.validate() { return false; } }
...
impl GroupHeader115 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref chrgs_rqstr_value) = self.chrgs_rqstr { if !chrgs_rqstr_value.validate() { return false; } }
		if let Some(ref ttl_chrgs_value) = self.ttl_chrgs { if !ttl_chrgs_value.validate() { return false; } }
		if let Some(ref chrgs_acct_agt_value) = self.chrgs_acct_agt { if !chrgs_acct_agt_value.validate() { return false; } }
		if let Some(ref chrgs_acct_agt_acct_value) = self.chrgs_acct_agt_acct { if !chrgs_acct_agt_acct_value.validate() { return false; } }
		return true
	}
...
impl TotalCharges7 {
	pub fn validate(&self) -> bool {
		if !self.nb_of_chrgs_rcrds.validate() { return false }
		if let Some(ref ttl_chrgs_amt_value) = self.ttl_chrgs_amt { if !ttl_chrgs_amt_value.validate() { return false; } }
		if let Some(ref cdt_dbt_ind_value) = self.cdt_dbt_ind { if !cdt_dbt_ind_value.validate() { return false; } }
		return true
	}
}
...
impl TotalCharges8 {
	pub fn validate(&self) -> bool {
		if !self.nb_of_chrgs_brkdwn_itms.validate() { return false }
		if let Some(ref ttl_chrgs_amt_value) = self.ttl_chrgs_amt { if !ttl_chrgs_amt_value.validate() { return false; } }
		if let Some(ref cdt_dbt_ind_value) = self.cdt_dbt_ind { if !cdt_dbt_ind_value.validate() { return false; } }
		return true
	}
