...
pub struct AdditionalRequestData1Choice {
	#[serde(rename = "ReqdDbtAuthstn", skip_serializing_if = "Option::is_none")]
	pub reqd_dbt_authstn: Option<DebitAuthorisation3>,
	#[serde(rename = "ReqdCompstn", skip_serializing_if = "Option::is_none")]
	pub reqd_compstn: Option<CompensationRequest1>,
	#[serde(rename = "ReqdValtn", skip_serializing_if = "Option::is_none")]
	pub reqd_valtn: Option<AdjustmentRequest1>,
	#[serde(rename = "ReqNrrtv", skip_serializing_if = "Option::is_none")]
	pub req_nrrtv: Option<Max500Text>,
}

impl AdditionalRequestData1Choice {
	pub fn validate(&self) -> bool {
		if let Some(ref reqd_dbt_authstn_value) = self.reqd_dbt_authstn { if !reqd_dbt_authstn_value.validate() { return false; } }
		if let Some(ref reqd_compstn_value) = self.reqd_compstn { if !reqd_compstn_value.validate() { return false; } }
		if let Some(ref reqd_valtn_value) = self.reqd_valtn { if !reqd_valtn_value.validate() { return false; } }
		if let Some(ref req_nrrtv_value) = self.req_nrrtv { if !req_nrrtv_value.validate() { return false; } }
		return true
	}
}
...
pub struct DebitAuthorisation3 {
	...
	#[serde(rename = "AddtlCxlRsnInf", skip_serializing_if = "Option::is_none")]
	pub addtl_cxl_rsn_inf: Option<Vec<Max140Text>>,
}
...
impl DebitAuthorisation3 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref addtl_cxl_rsn_inf_vec) = self.addtl_cxl_rsn_inf { for item in addtl_cxl_rsn_inf_vec { if !item.validate() { return false; } } }
		return true
	}
}
...
pub struct InvestigationReason2 {
	...
	#[serde(rename = "RsnSubTp", skip_serializing_if = "Option::is_none")]
	pub rsn_sub_tp: Option<InvestigationReasonSubType1Choice>,
	#[serde(rename = "AddtlReqData", skip_serializing_if = "Option::is_none")]
...
impl InvestigationReason2 {
	pub fn validate(&self) -> bool {
		if !self.rsn.validate() { return false }
		if let Some(ref rsn_sub_tp_value) = self.rsn_sub_tp { if !rsn_sub_tp_value.validate() { return false; } }
		if let Some(ref addtl_req_data_value) = self.addtl_req_data { if !addtl_req_data_value.validate() { return false; } }
...
impl InvestigationRequest2 {
	pub fn validate(&self) -> bool {
		...
		if !self.undrlyg.validate() { return false }
...
impl InvestigationRequestV01 {
	pub fn validate(&self) -> bool {
		if !self.invstgtn_req.validate() { return false }
		for item in &self.invstgtn_data { if !item.validate() { return false; } }
