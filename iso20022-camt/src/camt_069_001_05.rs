...
pub mod iso20022 {
	...
	impl GetStandingOrderV05 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			...
			if let Some(ref stg_ordr_qry_def_value) = self.stg_ordr_qry_def { if let Err(e) = stg_ordr_qry_def_value.validate() { return Err(e); } }
	...
	impl StandingOrderQuery5 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			...
			if let Some(ref stg_ordr_crit_value) = self.stg_ordr_crit { if let Err(e) = stg_ordr_crit_value.validate() { return Err(e); } }
			Ok(())
		}
	}
	...
	impl StandingOrderSearchCriteria5 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			if let Some(ref stg_ordr_id_value) = self.stg_ordr_id { if let Err(e) = stg_ordr_id_value.validate() { return Err(e); } }
			if let Some(ref tp_value) = self.tp { if let Err(e) = tp_value.validate() { return Err(e); } }
