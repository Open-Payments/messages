...
impl GetStandingOrderV05 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref stg_ordr_qry_def_value) = self.stg_ordr_qry_def { if !stg_ordr_qry_def_value.validate() { return false; } }
...
impl StandingOrderQuery5 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref stg_ordr_crit_value) = self.stg_ordr_crit { if !stg_ordr_crit_value.validate() { return false; } }
		return true
	}
}
...
impl StandingOrderSearchCriteria5 {
	pub fn validate(&self) -> bool {
		if let Some(ref stg_ordr_id_value) = self.stg_ordr_id { if !stg_ordr_id_value.validate() { return false; } }
		if let Some(ref tp_value) = self.tp { if !tp_value.validate() { return false; } }
