...
pub mod iso20022 {
	...
	impl AdjustmentCompensation1 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			...
			if let Some(ref val) = self.due_chrgs { if let Err(e) = val.validate() { return Err(e); } }
			if let Err(e) = self.amt_due.validate() { return Err(e); }
			if let Some(ref val) = self.compstn_agt { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.compstn_acct { if let Err(e) = val.validate() { return Err(e); } }
	...
	impl CompensationResponse1 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			if let Some(ref val) = self.initl_amt { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.pd_chrgs { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.amt_due { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.prd { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.rsn {
				if val.chars().count() < 1 {
					return Err(ValidationError::new(1001, "rsn is shorter than the minimum length of 1".to_string()));
	...
	impl DebitAuthorisationConfirmation3 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			if let Some(ref val) = self.amt_to_dbt { if let Err(e) = val.validate() { return Err(e); } }
	...
	impl Document12 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			...
			if let Some(ref val) = self.dgtl_sgntr { if let Err(e) = val.validate() { return Err(e); } }
	...
	impl FileData1 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			...
			if let Some(ref val) = self.frmt { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.file_nm {
				if val.chars().count() < 1 {
					return Err(ValidationError::new(1001, "file_nm is shorter than the minimum length of 1".to_string()));
				}
	...
	impl InvestigationData2 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			if let Some(ref val) = self.orgnl_invstgtn_rsn { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.orgnl_invstgtn_rsn_sub_tp { if let Err(e) = val.validate() { return Err(e); } }
			if let Err(e) = self.rspn_data.validate() { return Err(e); }
			if let Some(ref val) = self.rltd_invstgtn_data { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref vec) = self.nclsd_file { for item in vec { if let Err(e) = item.validate() { return Err(e); } } }
			if let Some(ref vec) = self.rltd_file_data { for item in vec { if let Err(e) = item.validate() { return Err(e); } } }
			if let Some(ref val) = self.rspn_orgtr { if let Err(e) = val.validate() { return Err(e); } }
			Ok(())
		}
	}
	...
	impl InvestigationDataRecord1Choice {
		pub fn validate(&self) -> Result<(), ValidationError> {
			if let Some(ref val) = self.dbt_authstn { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.compstn { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.valtn { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.conf { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.tx_sts { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref vec) = self.tx_data { for item in vec { if let Err(e) = item.validate() { return Err(e); } } }
	...
	impl InvestigationRequest3 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			...
			if let Some(ref val) = self.req_actn { if let Err(e) = val.validate() { return Err(e); } }
			if let Err(e) = self.invstgtn_tp.validate() { return Err(e); }
			if let Some(ref val) = self.invstgtn_sub_tp { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.undrlyg_instrm { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.undrlyg { if let Err(e) = val.validate() { return Err(e); } }
			if let Err(e) = self.rqstr.validate() { return Err(e); }
			if let Err(e) = self.rspndr.validate() { return Err(e); }
			if let Some(ref val) = self.req_orgtr { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.xpctd_rspndr { if let Err(e) = val.validate() { return Err(e); } }
	...
	impl InvestigationRequestAction1 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			...
			if let Some(ref val) = self.actn_rsn { if let Err(e) = val.validate() { return Err(e); } }
			Ok(())
		}
	}
	...
	impl InvestigationResponse3 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			...
			if let Some(ref val) = self.nxt_rspndr { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref vec) = self.invstgtn_data { for item in vec { if let Err(e) = item.validate() { return Err(e); } } }
			Ok(())
		}
	}
	...
	impl InvestigationStatus2 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			...
			if let Some(ref val) = self.sts_rsn { if let Err(e) = val.validate() { return Err(e); } }
			Ok(())
		}
	}
	...
	impl PaymentTransactionStatus1 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			...
			if let Some(ref vec) = self.sts_rsn_inf { for item in vec { if let Err(e) = item.validate() { return Err(e); } } }
			Ok(())
		}
	}
	...
	impl RelatedInvestigationData1 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			...
			if let Some(ref vec) = self.lctn { for item in vec { if let Err(e) = item.validate() { return Err(e); } } }
			Ok(())
		}
	}
	...
	impl Remittance1 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			...
			if let Some(ref vec) = self.rltd { for item in vec { if let Err(e) = item.validate() { return Err(e); } } }
			Ok(())
		}
	}
	...
	impl TransactionAmendment1Choice {
		pub fn validate(&self) -> Result<(), ValidationError> {
			...
			if let Some(ref val) = self.csh_acct { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.cd {
				if val.chars().count() < 1 {
					return Err(ValidationError::new(1001, "cd is shorter than the minimum length of 1".to_string()));
				}
			...
			if let Some(ref val) = self.pty { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.rmt { if let Err(e) = val.validate() { return Err(e); } }
	...
	impl UnderlyingData2Choice {
		pub fn validate(&self) -> Result<(), ValidationError> {
			if let Some(ref val) = self.initn { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.intr_bk { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.stmt_ntry { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.acct { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.othr { if let Err(e) = val.validate() { return Err(e); } }
			Ok(())
		}
	...
	impl UnderlyingPaymentInstruction8 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			...
			if let Some(ref val) = self.orgnl_instd_amt { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.reqd_exctn_dt { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.orgnl_tx_ref { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.orgnl_svc_lvl { if let Err(e) = val.validate() { return Err(e); } }
			Ok(())
		}
	}
	...
	impl UnderlyingStatementEntry5 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			if let Some(ref val) = self.orgnl_acct { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.orgnl_grp_inf { if let Err(e) = val.validate() { return Err(e); } }
			...
			if let Some(ref val) = self.orgnl_ntry_amt { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.orgnl_ntry_val_dt { if let Err(e) = val.validate() { return Err(e); } }
			Ok(())
		}
	}
