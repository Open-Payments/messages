...
impl GetReservationV08 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Some(ref rsvatn_qry_def_value) = self.rsvatn_qry_def { if let Err(e) = rsvatn_qry_def_value.validate() { return Err(e); } }
...
impl ReservationQuery6 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Some(ref rsvatn_crit_value) = self.rsvatn_crit { if let Err(e) = rsvatn_crit_value.validate() { return Err(e); } }
		Ok(())
	}
}
...
impl ReservationSearchCriteria6 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Some(ref dflt_rsvatn_tp_vec) = self.dflt_rsvatn_tp { for item in dflt_rsvatn_tp_vec { if let Err(e) = item.validate() { return Err(e); } } }
		if let Some(ref cur_rsvatn_tp_vec) = self.cur_rsvatn_tp { for item in cur_rsvatn_tp_vec { if let Err(e) = item.validate() { return Err(e); } } }
