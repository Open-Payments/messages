...
#[derive(Debug, PartialEq, Clone, Validate, Serialize, Deserialize)]
pub struct CancellationProcessingStatus3Code {
	#[validate(enumerate = ["CANP", "REJT", "REPR", "PACK", "DEND", "CAND"])]
	#[serde(rename = "CancellationProcessingStatus3Code")]
	pub cancellation_processing_status3_code: String,
}
