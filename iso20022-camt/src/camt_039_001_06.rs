...
pub mod iso20022 {
	...
	impl CaseStatus2 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			if let Err(e) = self.case_sts.validate() { return Err(e); }
	...
	pub struct CaseStatusReportV06 {
		...
		#[cfg_attr( feature = "derive_serde", serde(rename = "Case") )]
		pub case: Case6,
		#[cfg_attr( feature = "derive_serde", serde(rename = "Sts") )]
		pub sts: CaseStatus2,
		#[cfg_attr( feature = "derive_serde", serde(rename = "NewAssgnmt", skip_serializing_if = "Option::is_none") )]
		pub new_assgnmt: Option<CaseAssignment6>,
		#[cfg_attr( feature = "derive_serde", serde(rename = "SplmtryData", skip_serializing_if = "Option::is_none") )]
		pub splmtry_data: Option<Vec<SupplementaryData1>>,
	}
	
	impl CaseStatusReportV06 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			if let Err(e) = self.hdr.validate() { return Err(e); }
			if let Err(e) = self.case.validate() { return Err(e); }
			if let Err(e) = self.sts.validate() { return Err(e); }
			if let Some(ref new_assgnmt_value) = self.new_assgnmt { if let Err(e) = new_assgnmt_value.validate() { return Err(e); } }
