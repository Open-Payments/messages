...
pub mod iso20022 {
	...
	impl Amount4Choice {
		pub fn validate(&self) -> Result<(), ValidationError> {
			if let Some(ref val) = self.incr_amt { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.dcr_amt { if let Err(e) = val.validate() { return Err(e); } }
			Ok(())
		}
	}
	...
	impl LimitIdentification3Choice {
		pub fn validate(&self) -> Result<(), ValidationError> {
			if let Some(ref val) = self.cur { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.dflt { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.all_cur { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.all_dflt { if let Err(e) = val.validate() { return Err(e); } }
			Ok(())
		}
	}
	...
	impl LimitIdentification8 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			...
			if let Some(ref val) = self.bil_lmt_ctr_pty_id { if let Err(e) = val.validate() { return Err(e); } }
	...
	impl LimitStructure5 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			...
			if let Some(ref val) = self.od_lmt_val_set { if let Err(e) = val.validate() { return Err(e); } }
			if let Some(ref val) = self.lmt_val_amdmnt { if let Err(e) = val.validate() { return Err(e); } }
			Ok(())
		}
	}
	...
	impl ModifyLimitV08 {
		pub fn validate(&self) -> Result<(), ValidationError> {
			...
			if let Some(ref vec) = self.lmt_dtls { for item in vec { if let Err(e) = item.validate() { return Err(e); } } }
