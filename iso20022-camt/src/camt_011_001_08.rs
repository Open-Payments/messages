...
impl Amount4Choice {
	pub fn validate(&self) -> bool {
		if let Some(ref incr_amt_value) = self.incr_amt { if !incr_amt_value.validate() { return false; } }
		if let Some(ref dcr_amt_value) = self.dcr_amt { if !dcr_amt_value.validate() { return false; } }
		return true
	}
}
...
impl Limit8 {
	pub fn validate(&self) -> bool {
		if let Some(ref start_dt_tm_value) = self.start_dt_tm { if !start_dt_tm_value.validate() { return false; } }
		if !self.amt.validate() { return false }
		if let Some(ref cdt_dbt_ind_value) = self.cdt_dbt_ind { if !cdt_dbt_ind_value.validate() { return false; } }
		return true
	}
...
impl LimitIdentification3Choice {
	pub fn validate(&self) -> bool {
		if let Some(ref cur_value) = self.cur { if !cur_value.validate() { return false; } }
		if let Some(ref dflt_value) = self.dflt { if !dflt_value.validate() { return false; } }
		if let Some(ref all_cur_value) = self.all_cur { if !all_cur_value.validate() { return false; } }
		if let Some(ref all_dflt_value) = self.all_dflt { if !all_dflt_value.validate() { return false; } }
		return true
	}
}
...
impl LimitIdentification8 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref bil_lmt_ctr_pty_id_value) = self.bil_lmt_ctr_pty_id { if !bil_lmt_ctr_pty_id_value.validate() { return false; } }
...
pub struct LimitStructure5 {
	...
	#[serde(rename = "OdLmtValSet", skip_serializing_if = "Option::is_none")]
	pub od_lmt_val_set: Option<Limit10>,
	#[serde(rename = "LmtValAmdmnt", skip_serializing_if = "Option::is_none")]
	pub lmt_val_amdmnt: Option<Amount4Choice>,
}

impl LimitStructure5 {
	pub fn validate(&self) -> bool {
		if !self.lmt_id.validate() { return false }
		if !self.new_lmt_val_set.validate() { return false }
		if let Some(ref od_lmt_val_set_value) = self.od_lmt_val_set { if !od_lmt_val_set_value.validate() { return false; } }
		if let Some(ref lmt_val_amdmnt_value) = self.lmt_val_amdmnt { if !lmt_val_amdmnt_value.validate() { return false; } }
		return true
	}
}
...
pub struct ModifyLimitV08 {
	...
	#[serde(rename = "LmtDtls", skip_serializing_if = "Option::is_none")]
	pub lmt_dtls: Option<Vec<LimitStructure5>>,
...
impl ModifyLimitV08 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref lmt_dtls_vec) = self.lmt_dtls { for item in lmt_dtls_vec { if !item.validate() { return false; } } }
