...
impl NotificationToReceiveStatusReportV08 {
	pub fn validate(&self) -> bool {
		...
		if !self.orgnl_ntfctn_and_sts.validate() { return false }
...
impl OriginalItemAndStatus8 {
	pub fn validate(&self) -> bool {
		...
		if !self.amt.validate() { return false }
		if !self.itm_sts.validate() { return false }
		if let Some(ref addtl_sts_inf_value) = self.addtl_sts_inf { if !addtl_sts_inf_value.validate() { return false; } }
...
impl OriginalNotification15 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref ntfctn_sts_value) = self.ntfctn_sts { if !ntfctn_sts_value.validate() { return false; } }
		if let Some(ref addtl_sts_inf_value) = self.addtl_sts_inf { if !addtl_sts_inf_value.validate() { return false; } }
...
impl OriginalNotificationReference13 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref dbtr_agt_value) = self.dbtr_agt { if !dbtr_agt_value.validate() { return false; } }
		if let Some(ref intrmy_agt_value) = self.intrmy_agt { if !intrmy_agt_value.validate() { return false; } }
		for item in &self.orgnl_itm_and_sts { if !item.validate() { return false; } }
		return true
	}
}
