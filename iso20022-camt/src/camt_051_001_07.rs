...
impl LiquidityDebitTransfer4 {
	pub fn validate(&self) -> bool {
		if let Some(ref lqdty_trf_id_value) = self.lqdty_trf_id { if !lqdty_trf_id_value.validate() { return false; } }
...
impl LiquidityDebitTransferV07 {
	pub fn validate(&self) -> bool {
		if !self.msg_hdr.validate() { return false }
		if !self.lqdty_dbt_trf.validate() { return false }
