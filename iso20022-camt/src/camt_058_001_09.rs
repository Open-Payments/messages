...
pub struct ExternalNotificationCancellationReason1Code {
	#[serde(rename = "$value")]
	pub external_notification_cancellation_reason1_code: String,
}

impl ExternalNotificationCancellationReason1Code {
	pub fn validate(&self) -> bool {
		if self.external_notification_cancellation_reason1_code.chars().count() < 1 {
			return false
		}
		if self.external_notification_cancellation_reason1_code.chars().count() > 4 {
			return false
		}
		return true
	}
...
// NotificationToReceiveCancellationAdviceV09 ...
#[derive(Debug, Default, PartialEq, Clone, Serialize, Deserialize)]
pub struct NotificationToReceiveCancellationAdviceV09 {
	#[serde(rename = "GrpHdr")]
	pub grp_hdr: GroupHeader117,
	#[serde(rename = "OrgnlNtfctn")]
	pub orgnl_ntfctn: OriginalNotification16,
	#[serde(rename = "CxlRsn", skip_serializing_if = "Option::is_none")]
	pub cxl_rsn: Option<NotificationCancellationReason2>,
	#[serde(rename = "SplmtryData", skip_serializing_if = "Option::is_none")]
	pub splmtry_data: Option<Vec<SupplementaryData1>>,
}

impl NotificationToReceiveCancellationAdviceV09 {
	pub fn validate(&self) -> bool {
		if !self.grp_hdr.validate() { return false }
		if !self.orgnl_ntfctn.validate() { return false }
...
impl OriginalItem8 {
	pub fn validate(&self) -> bool {
		if !self.orgnl_itm_id.validate() { return false }
		...
		if !self.amt.validate() { return false }
		if let Some(ref orgnl_itm_ref_value) = self.orgnl_itm_ref { if !orgnl_itm_ref_value.validate() { return false; } }
		return true
	}
}
...
impl OriginalNotification16 {
	pub fn validate(&self) -> bool {
		...
		if !self.orgnl_ntfctn_id.validate() { return false }
		if let Some(ref orgnl_ntfctn_ref_vec) = self.orgnl_ntfctn_ref { for item in orgnl_ntfctn_ref_vec { if !item.validate() { return false; } } }
		return true
	}
}
...
impl OriginalNotificationReference14 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref dbtr_agt_value) = self.dbtr_agt { if !dbtr_agt_value.validate() { return false; } }
		if let Some(ref intrmy_agt_value) = self.intrmy_agt { if !intrmy_agt_value.validate() { return false; } }
		for item in &self.orgnl_itm { if !item.validate() { return false; } }
		return true
	}
}
