...
impl GroupHeader117 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Some(ref val) = self.msg_sndr { if let Err(e) = val.validate() { return Err(e); } }
		Ok(())
	}
}
...
impl OriginalItem8 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Err(e) = self.amt.validate() { return Err(e); }
		if let Some(ref val) = self.orgnl_itm_ref { if let Err(e) = val.validate() { return Err(e); } }
		Ok(())
	}
}
...
impl OriginalItemReference7 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Some(ref val) = self.intrmy_agt { if let Err(e) = val.validate() { return Err(e); } }
		if let Some(ref val) = self.purp { if let Err(e) = val.validate() { return Err(e); } }
		if let Some(ref val) = self.rltd_rmt_inf { if let Err(e) = val.validate() { return Err(e); } }
...
impl OriginalNotification16 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Some(ref vec) = self.orgnl_ntfctn_ref { for item in vec { if let Err(e) = item.validate() { return Err(e); } } }
		Ok(())
	}
}
