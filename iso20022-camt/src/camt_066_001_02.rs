...
impl IntraBalanceMovementInstructionV02 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref nb_counts_value) = self.nb_counts { if !nb_counts_value.validate() { return false; } }
		...
		if !self.intra_bal.validate() { return false }
...
impl NumberCount1Choice {
	pub fn validate(&self) -> bool {
		if let Some(ref cur_instr_nb_value) = self.cur_instr_nb { if !cur_instr_nb_value.validate() { return false; } }
		if let Some(ref ttl_nb_value) = self.ttl_nb { if !ttl_nb_value.validate() { return false; } }
		return true
	}
}
...
impl TotalNumber1 {
	pub fn validate(&self) -> bool {
		if !self.cur_instr_nb.validate() { return false }
		if !self.ttl_of_lkd_instrs.validate() { return false }
		return true
	}
}
...
impl TransactionAndDocumentIdentification6 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref doc_id_value) = self.doc_id { if !doc_id_value.validate() { return false; } }
