...
impl RemittanceLocation10 {
	pub fn validate(&self) -> bool {
		...
		for item in &self.rmt_lctn_dtls { if !item.validate() { return false; } }
...
pub struct RemittanceLocationAdviceV03 {
	...
	#[serde(rename = "RmtLctn")]
	pub rmt_lctn: Vec<RemittanceLocation10>,
	#[serde(rename = "SplmtryData", skip_serializing_if = "Option::is_none")]
	pub splmtry_data: Option<Vec<SupplementaryData1>>,
}

impl RemittanceLocationAdviceV03 {
	pub fn validate(&self) -> bool {
		if !self.grp_hdr.validate() { return false }
		for item in &self.rmt_lctn { if !item.validate() { return false; } }
