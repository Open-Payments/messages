...
impl GroupHeader122 {
	pub fn validate(&self) -> bool {
		...
		if let Some(ref cpy_ind_value) = self.cpy_ind { if !cpy_ind_value.validate() { return false; } }
...
// RemittanceAdviceV06 ...
#[derive(Debug, Default, PartialEq, Clone, Serialize, Deserialize)]
pub struct RemittanceAdviceV06 {
	#[serde(rename = "GrpHdr")]
	pub grp_hdr: GroupHeader122,
	#[serde(rename = "RmtInf")]
	pub rmt_inf: Vec<RemittanceInformation23>,
	#[serde(rename = "SplmtryData", skip_serializing_if = "Option::is_none")]
	pub splmtry_data: Option<Vec<SupplementaryData1>>,
}

impl RemittanceAdviceV06 {
	pub fn validate(&self) -> bool {
		if !self.grp_hdr.validate() { return false }
		for item in &self.rmt_inf { if !item.validate() { return false; } }
...
impl RemittanceInformation23 {
	pub fn validate(&self) -> bool {
		...
		if !self.orgnl_pmt_inf.validate() { return false }
		return true
	}
}
